...
.method public constructor <init>(LZo/D;II)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:LZo/h;
...
.method public synthetic constructor <init>(LZo/D;IIILkotlin/jvm/internal/g;)V
    .locals 0
    ...
    .line 9
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(LZo/D;II)V
...
.method private final getName(I)LZo/i;
    .locals 3
    ...
    .line 14
    .line 15
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:LZo/i;
...
.method private final readByte()I
    ...
    .line 1
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:LZo/h;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)LZo/i;
    ...
    .line 5
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()LZo/i;
    ...
    .line 10
    .line 11
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(LZo/i;LZo/i;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    .line 7
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(LZo/i;)LZo/i;
    ...
    .line 16
    .line 17
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(LZo/i;LZo/i;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    .line 12
    .line 13
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(LZo/i;LZo/i;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    .line 18
    .line 19
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(LZo/i;LZo/i;)V
...
.method public final readByteString()LZo/i;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 29
    .line 30
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:LZo/h;

    .line 31
    .line 32
    invoke-virtual {v1, v4, v2, v3, v0}, Lokhttp3/internal/http2/Huffman;->decode(LZo/h;JLZo/g;)V
    ...
    .line 43
    .line 44
    invoke-interface {v0, v2, v3}, LZo/h;->W(J)LZo/i;
...
.method public final readHeaders()V
    ...
    .line 2
    .line 3
    invoke-interface {v0}, LZo/h;->b0()Z
