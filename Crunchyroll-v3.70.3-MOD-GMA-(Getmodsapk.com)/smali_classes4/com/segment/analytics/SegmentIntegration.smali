...
.method public constructor <init>(Landroid/content/Context;Lcom/segment/analytics/Client;Lcom/segment/analytics/Cartographer;Ljava/util/concurrent/ExecutorService;Lcom/segment/analytics/PayloadQueue;Lcom/segment/analytics/Stats;Ljava/util/Map;JILcom/segment/analytics/integrations/Logger;Lcom/segment/analytics/Crypto;Ljava/lang/String;)V
    ...
    .line 13
    iput-object v4, v0, Lcom/segment/analytics/SegmentIntegration;->crypto:Lcom/segment/analytics/Crypto;

    move-object/from16 v4, p13

    .line 14
    iput-object v4, v0, Lcom/segment/analytics/SegmentIntegration;->apiHost:Ljava/lang/String;
    ...
    iput-object v4, v0, Lcom/segment/analytics/SegmentIntegration;->segmentThread:Landroid/os/HandlerThread;

    .line 16
    invoke-virtual {v4}, Ljava/lang/Thread;->start()V

    .line 17
    new-instance v5, Lcom/segment/analytics/SegmentIntegration$SegmentDispatcherHandler;

    invoke-virtual {v4}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v4

    invoke-direct {v5, v4, p0}, Lcom/segment/analytics/SegmentIntegration$SegmentDispatcherHandler;-><init>(Landroid/os/Looper;Lcom/segment/analytics/SegmentIntegration;)V

    iput-object v5, v0, Lcom/segment/analytics/SegmentIntegration;->handler:Landroid/os/Handler;
...
.method public static declared-synchronized create(Landroid/content/Context;Lcom/segment/analytics/Client;Lcom/segment/analytics/Cartographer;Ljava/util/concurrent/ExecutorService;Lcom/segment/analytics/Stats;Ljava/util/Map;Ljava/lang/String;JILcom/segment/analytics/integrations/Logger;Lcom/segment/analytics/Crypto;Lcom/segment/analytics/ValueMap;)Lcom/segment/analytics/SegmentIntegration;
    .locals 17
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v2, v0}, Lcom/segment/analytics/ValueMap;->getString(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v16}, Lcom/segment/analytics/SegmentIntegration;-><init>(Landroid/content/Context;Lcom/segment/analytics/Client;Lcom/segment/analytics/Cartographer;Ljava/util/concurrent/ExecutorService;Lcom/segment/analytics/PayloadQueue;Lcom/segment/analytics/Stats;Ljava/util/Map;JILcom/segment/analytics/integrations/Logger;Lcom/segment/analytics/Crypto;Ljava/lang/String;)V
    :try_end_2
...
.method public performEnqueue(Lcom/segment/analytics/integrations/BasePayload;)V
    ...
    .line 1
    const-string v0, "Could not serialize payload "
    ...
    .line 8
    .line 9
    invoke-virtual {v1}, Lcom/segment/analytics/ValueMap;->size()I
    ...
    .line 13
    iget-object v4, p0, Lcom/segment/analytics/SegmentIntegration;->bundledIntegrations:Ljava/util/Map;
    ...
    .line 25
    .line 26
    iget-object v1, p0, Lcom/segment/analytics/SegmentIntegration;->bundledIntegrations:Ljava/util/Map;
    ...
    .line 40
    .line 41
    invoke-virtual {v1, p1}, Lcom/segment/analytics/ValueMap;->putAll(Ljava/util/Map;)V
    ...
    .line 45
    .line 46
    invoke-virtual {v1, v3, v2}, Lcom/segment/analytics/ValueMap;->put(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 58
    .line 59
    iget-object v2, p0, Lcom/segment/analytics/SegmentIntegration;->flushLock:Ljava/lang/Object;
    ...
    .line 63
    .line 64
    invoke-virtual {v4}, Lcom/segment/analytics/PayloadQueue;->size()I
    ...
    .line 71
    .line 72
    const-string v4, "Queue is at max capacity (%s), removing oldest payload."
    ...
    .line 94
    invoke-virtual {v3, v4}, Lcom/segment/analytics/PayloadQueue;->remove(I)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .line 107
    .line 108
    invoke-virtual {v0, p1, v1, v3}, Lcom/segment/analytics/integrations/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 121
    .line 122
    iget-object v3, p0, Lcom/segment/analytics/SegmentIntegration;->crypto:Lcom/segment/analytics/Crypto;

    .line 123
    .line 124
    invoke-virtual {v3, v2}, Lcom/segment/analytics/Crypto;->encrypt(Ljava/io/OutputStream;)Ljava/io/OutputStream;
    ...
    .line 128
    iget-object v4, p0, Lcom/segment/analytics/SegmentIntegration;->cartographer:Lcom/segment/analytics/Cartographer;
    ...
    .line 134
    .line 135
    invoke-virtual {v4, v1, v5}, Lcom/segment/analytics/Cartographer;->toJson(Ljava/util/Map;Ljava/io/Writer;)V
    ...
    .line 153
    .line 154
    invoke-virtual {v0, v2}, Lcom/segment/analytics/PayloadQueue;->add([B)V
    :try_end_3
    ...
    .line 175
    invoke-virtual {v0, v1, p1}, Lcom/segment/analytics/integrations/Logger;->verbose(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 222
    invoke-virtual {v0, p1, v2, v1}, Lcom/segment/analytics/integrations/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public performFlush()V
    ...
    .line 15
    .line 16
    const-string v4, "Uploading payloads in queue to Segment."
    ...
    .line 20
    .line 21
    invoke-virtual {v3, v4, v6}, Lcom/segment/analytics/integrations/Logger;->verbose(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 25
    :try_start_0
    iget-object v4, p0, Lcom/segment/analytics/SegmentIntegration;->client:Lcom/segment/analytics/Client;

    .line 26
    .line 27
    iget-object v6, p0, Lcom/segment/analytics/SegmentIntegration;->apiHost:Ljava/lang/String;

    .line 28
    .line 29
    invoke-virtual {v4, v6}, Lcom/segment/analytics/Client;->upload(Ljava/lang/String;)Lcom/segment/analytics/Client$Connection;
    ...
    .line 33
    new-instance v4, Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;
    ...
    .line 36
    .line 37
    invoke-direct {v4, v6}, Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;-><init>(Ljava/io/OutputStream;)V

    .line 38
    .line 39
    .line 40
    invoke-virtual {v4}, Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;->beginObject()Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;
    ...
    .line 44
    invoke-virtual {v4}, Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;->beginBatchArray()Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;
    ...
    .line 51
    .line 52
    invoke-direct {v6, v4, v7}, Lcom/segment/analytics/SegmentIntegration$PayloadWriter;-><init>(Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;Lcom/segment/analytics/Crypto;)V
    ...
    .line 59
    .line 60
    invoke-virtual {v4}, Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;->endBatchArray()Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;
    ...
    .line 64
    iget-object v7, p0, Lcom/segment/analytics/SegmentIntegration;->client:Lcom/segment/analytics/Client;

    .line 65
    .line 66
    iget-object v7, v7, Lcom/segment/analytics/Client;->writeKey:Ljava/lang/String;

    .line 67
    .line 68
    invoke-virtual {v4, v7}, Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;->endObject(Ljava/lang/String;)Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;
    ...
    .line 72
    invoke-virtual {v4}, Lcom/segment/analytics/SegmentIntegration$BatchPayloadWriter;->close()V

    .line 73
    .line 74
    .line 75
    iget v4, v6, Lcom/segment/analytics/SegmentIntegration$PayloadWriter;->payloadCount:I
    :try_end_0
    ...
    :try_end_1
    .catch Lcom/segment/analytics/Client$HTTPException; {:try_start_1 .. :try_end_1} :catch_2
    ...
    .line 84
    .line 85
    invoke-virtual {v0, v4}, Lcom/segment/analytics/PayloadQueue;->remove(I)V
    :try_end_2
    ...
    .line 114
    .line 115
    invoke-virtual {v0, v4}, Lcom/segment/analytics/Stats;->dispatchFlush(I)V
    ...
    .line 132
    .line 133
    invoke-static {v4, v2, v1}, LH0/m;->d(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 138
    .line 139
    invoke-virtual {v3, v0, v1, v2}, Lcom/segment/analytics/integrations/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 155
    .line 156
    invoke-virtual {v2, v1, v0, v4}, Lcom/segment/analytics/integrations/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_3
    ...
    .line 180
    .line 181
    invoke-virtual {v0, v6, v7, v8}, Lcom/segment/analytics/integrations/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_4
    ...
    .line 208
    .line 209
    invoke-virtual {v0, v6, v1, v2}, Lcom/segment/analytics/integrations/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_6
    ...
    .line 219
    .line 220
    invoke-virtual {v1, v6, v0, v2}, Lcom/segment/analytics/integrations/Logger;->error(Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_7
