...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget v2, Landroidx/leanback/R$fraction;->lb_search_bar_speech_orb_max_level_zoom:I
    ...
    iput v2, p0, Landroidx/leanback/widget/SpeechOrbView;->mSoundLevelMaxZoom:F

    new-instance v2, Landroidx/leanback/widget/SearchOrbView$Colors;

    sget v3, Landroidx/leanback/R$color;->lb_speech_orb_not_recording:I

    invoke-virtual {v1, v3}, Landroid/content/res/Resources;->getColor(I)I

    move-result v3

    sget v4, Landroidx/leanback/R$color;->lb_speech_orb_not_recording_pulsed:I

    invoke-virtual {v1, v4}, Landroid/content/res/Resources;->getColor(I)I

    move-result v4

    sget v5, Landroidx/leanback/R$color;->lb_speech_orb_not_recording_icon:I

    invoke-virtual {v1, v5}, Landroid/content/res/Resources;->getColor(I)I

    move-result v5

    invoke-direct {v2, v3, v4, v5}, Landroidx/leanback/widget/SearchOrbView$Colors;-><init>(III)V

    iput-object v2, p0, Landroidx/leanback/widget/SpeechOrbView;->mNotListeningOrbColors:Landroidx/leanback/widget/SearchOrbView$Colors;

    new-instance v2, Landroidx/leanback/widget/SearchOrbView$Colors;

    sget v3, Landroidx/leanback/R$color;->lb_speech_orb_recording:I

    invoke-virtual {v1, v3}, Landroid/content/res/Resources;->getColor(I)I

    move-result v3

    sget v4, Landroidx/leanback/R$color;->lb_speech_orb_recording:I

    invoke-virtual {v1, v4}, Landroid/content/res/Resources;->getColor(I)I

    move-result v4

    invoke-direct {v2, v3, v4, v0}, Landroidx/leanback/widget/SearchOrbView$Colors;-><init>(III)V

    iput-object v2, p0, Landroidx/leanback/widget/SpeechOrbView;->mListeningOrbColors:Landroidx/leanback/widget/SearchOrbView$Colors;
