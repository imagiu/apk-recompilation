...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput v0, p0, Landroidx/leanback/widget/ThumbsBar;->mNumOfThumbs:I

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Landroidx/leanback/widget/ThumbsBar;->mBitmaps:Landroid/util/SparseArray;
    ...
    sget v1, Landroidx/leanback/R$dimen;->lb_playback_transport_thumbs_width:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroidx/leanback/widget/ThumbsBar;->mThumbWidthInPixel:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Landroidx/leanback/R$dimen;->lb_playback_transport_thumbs_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroidx/leanback/widget/ThumbsBar;->mThumbHeightInPixel:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Landroidx/leanback/R$dimen;->lb_playback_transport_hero_thumbs_width:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroidx/leanback/widget/ThumbsBar;->mHeroThumbHeightInPixel:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Landroidx/leanback/R$dimen;->lb_playback_transport_hero_thumbs_height:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroidx/leanback/widget/ThumbsBar;->mHeroThumbWidthInPixel:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Landroidx/leanback/R$dimen;->lb_playback_transport_thumbs_margin:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Landroidx/leanback/widget/ThumbsBar;->mMeasuredMarginInPixel:I
...
.method private calculateNumOfThumbs(I)I
    ...
    iget v2, p0, Landroidx/leanback/widget/ThumbsBar;->mMeasuredMarginInPixel:I

    add-int/2addr v1, v2

    invoke-static {v0, v1}, Landroidx/leanback/widget/ThumbsBar;->roundUp(II)I
...
.method protected onLayout(ZIIII)V
    ...
    iget v6, p0, Landroidx/leanback/widget/ThumbsBar;->mMeasuredMarginInPixel:I

    sub-int/2addr v2, v6

    invoke-virtual {p0, v5}, Landroidx/leanback/widget/ThumbsBar;->getChildAt(I)Landroid/view/View;
    ...
    :goto_1
    iget v6, p0, Landroidx/leanback/widget/ThumbsBar;->mNumOfThumbs:I
...
.method protected onMeasure(II)V
    ...
    iget-boolean v1, p0, Landroidx/leanback/widget/ThumbsBar;->mIsUserSets:Z

    if-nez v1, :cond_0

    invoke-direct {p0, v0}, Landroidx/leanback/widget/ThumbsBar;->calculateNumOfThumbs(I)I

    move-result v1

    iget v2, p0, Landroidx/leanback/widget/ThumbsBar;->mNumOfThumbs:I

    if-eq v2, v1, :cond_0

    iput v1, p0, Landroidx/leanback/widget/ThumbsBar;->mNumOfThumbs:I
