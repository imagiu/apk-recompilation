...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v1, v0, Landroidx/leanback/widget/PagingIndicator;->mAnimator:Landroid/animation/AnimatorSet;
    ...
    sget v7, Landroidx/leanback/R$styleable;->PagingIndicator_lbDotRadius:I

    sget v8, Landroidx/leanback/R$dimen;->lb_page_indicator_dot_radius:I

    invoke-direct {v0, v2, v7, v8}, Landroidx/leanback/widget/PagingIndicator;->getDimensionFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result v7

    iput v7, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I

    iget v7, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I

    const/4 v8, 0x2

    mul-int/lit8 v7, v7, 0x2

    iput v7, v0, Landroidx/leanback/widget/PagingIndicator;->mDotDiameter:I

    sget v7, Landroidx/leanback/R$styleable;->PagingIndicator_arrowRadius:I

    sget v9, Landroidx/leanback/R$dimen;->lb_page_indicator_arrow_radius:I

    invoke-direct {v0, v2, v7, v9}, Landroidx/leanback/widget/PagingIndicator;->getDimensionFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result v7

    iput v7, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRadius:I

    iget v7, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRadius:I

    mul-int/lit8 v7, v7, 0x2

    iput v7, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowDiameter:I

    sget v7, Landroidx/leanback/R$styleable;->PagingIndicator_dotToDotGap:I
    ...
    iput v7, v0, Landroidx/leanback/widget/PagingIndicator;->mDotGap:I

    sget v7, Landroidx/leanback/R$styleable;->PagingIndicator_dotToArrowGap:I
    ...
    iput v7, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowGap:I

    sget v7, Landroidx/leanback/R$styleable;->PagingIndicator_dotBgColor:I

    sget v9, Landroidx/leanback/R$color;->lb_page_indicator_dot:I

    invoke-direct {v0, v2, v7, v9}, Landroidx/leanback/widget/PagingIndicator;->getColorFromTypedArray(Landroid/content/res/TypedArray;II)I
    ...
    iput-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mBgPaint:Landroid/graphics/Paint;

    iget-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mBgPaint:Landroid/graphics/Paint;

    invoke-virtual {v9, v7}, Landroid/graphics/Paint;->setColor(I)V

    sget v9, Landroidx/leanback/R$styleable;->PagingIndicator_arrowBgColor:I

    sget v11, Landroidx/leanback/R$color;->lb_page_indicator_arrow_background:I

    invoke-direct {v0, v2, v9, v11}, Landroidx/leanback/widget/PagingIndicator;->getColorFromTypedArray(Landroid/content/res/TypedArray;II)I

    move-result v9

    iput v9, v0, Landroidx/leanback/widget/PagingIndicator;->mDotFgSelectColor:I

    iget-object v9, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowPaint:Landroid/graphics/Paint;

    if-nez v9, :cond_0

    sget v9, Landroidx/leanback/R$styleable;->PagingIndicator_arrowColor:I
    ...
    invoke-virtual {v0, v9}, Landroidx/leanback/widget/PagingIndicator;->setArrowColor(I)V
    ...
    :goto_0
    iput-boolean v9, v0, Landroidx/leanback/widget/PagingIndicator;->mIsLtr:Z

    sget v9, Landroidx/leanback/R$color;->lb_page_indicator_arrow_shadow:I

    invoke-virtual {v1, v9}, Landroid/content/res/Resources;->getColor(I)I

    move-result v9

    sget v11, Landroidx/leanback/R$dimen;->lb_page_indicator_arrow_shadow_radius:I

    invoke-virtual {v1, v11}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v11

    iput v11, v0, Landroidx/leanback/widget/PagingIndicator;->mShadowRadius:I

    new-instance v11, Landroid/graphics/Paint;

    invoke-direct {v11, v10}, Landroid/graphics/Paint;-><init>(I)V

    iput-object v11, v0, Landroidx/leanback/widget/PagingIndicator;->mFgPaint:Landroid/graphics/Paint;
    ...
    iget-object v12, v0, Landroidx/leanback/widget/PagingIndicator;->mFgPaint:Landroid/graphics/Paint;

    iget v13, v0, Landroidx/leanback/widget/PagingIndicator;->mShadowRadius:I
    ...
    iput-object v12, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;

    new-instance v12, Landroid/graphics/Rect;

    iget-object v13, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;

    invoke-virtual {v13}, Landroid/graphics/Bitmap;->getWidth()I

    move-result v13

    iget-object v14, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;
    ...
    iput-object v12, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRect:Landroid/graphics/Rect;

    iget-object v12, v0, Landroidx/leanback/widget/PagingIndicator;->mArrow:Landroid/graphics/Bitmap;
    ...
    iget v13, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowDiameter:I

    int-to-float v13, v13

    div-float/2addr v12, v13

    iput v12, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowToBgRatio:F

    new-instance v12, Landroid/animation/AnimatorSet;

    invoke-direct {v12}, Landroid/animation/AnimatorSet;-><init>()V

    iput-object v12, v0, Landroidx/leanback/widget/PagingIndicator;->mShowAnimator:Landroid/animation/AnimatorSet;

    iget-object v12, v0, Landroidx/leanback/widget/PagingIndicator;->mShowAnimator:Landroid/animation/AnimatorSet;

    const/4 v13, 0x0

    const/high16 v14, 0x3f800000    # 1.0f

    invoke-direct {v0, v13, v14}, Landroidx/leanback/widget/PagingIndicator;->createDotAlphaAnimator(FF)Landroid/animation/Animator;

    move-result-object v15

    iget v13, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I

    mul-int/lit8 v13, v13, 0x2

    int-to-float v13, v13

    iget v14, v0, Landroidx/leanback/widget/PagingIndicator;->mArrowRadius:I

    mul-int/lit8 v14, v14, 0x2

    int-to-float v14, v14

    invoke-direct {v0, v13, v14}, Landroidx/leanback/widget/PagingIndicator;->createDotDiameterAnimator(FF)Landroid/animation/Animator;
    ...
    iput-object v1, v0, Landroidx/leanback/widget/PagingIndicator;->mHideAnimator:Landroid/animation/AnimatorSet;

    iget-object v1, v0, Landroidx/leanback/widget/PagingIndicator;->mHideAnimator:Landroid/animation/AnimatorSet;

    const/high16 v12, 0x3f800000    # 1.0f

    const/4 v14, 0x0

    invoke-direct {v0, v12, v14}, Landroidx/leanback/widget/PagingIndicator;->createDotAlphaAnimator(FF)Landroid/animation/Animator;
    ...
    iget v15, v0, Landroidx/leanback/widget/PagingIndicator;->mDotRadius:I

    mul-int/lit8 v15, v15, 0x2

    int-to-float v15, v15

    invoke-direct {v0, v14, v15}, Landroidx/leanback/widget/PagingIndicator;->createDotDiameterAnimator(FF)Landroid/animation/Animator;
    ...
    iget-object v1, v0, Landroidx/leanback/widget/PagingIndicator;->mAnimator:Landroid/animation/AnimatorSet;
    ...
    iget-object v3, v0, Landroidx/leanback/widget/PagingIndicator;->mHideAnimator:Landroid/animation/AnimatorSet;
    ...
    invoke-virtual {v0, v10, v1}, Landroidx/leanback/widget/PagingIndicator;->setLayerType(ILandroid/graphics/Paint;)V
