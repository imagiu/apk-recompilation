...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    :try_start_0
    sget v2, Landroidx/leanback/R$styleable;->lbBaseCardView_cardType:I

    invoke-virtual {v0, v2, v1}, Landroid/content/res/TypedArray;->getInteger(II)I

    move-result v1

    iput v1, p0, Landroidx/leanback/widget/BaseCardView;->mCardType:I

    sget v1, Landroidx/leanback/R$styleable;->lbBaseCardView_cardForeground:I
    ...
    invoke-virtual {p0, v1}, Landroidx/leanback/widget/BaseCardView;->setForeground(Landroid/graphics/drawable/Drawable;)V

    :cond_0
    sget v2, Landroidx/leanback/R$styleable;->lbBaseCardView_cardBackground:I
    ...
    invoke-virtual {p0, v2}, Landroidx/leanback/widget/BaseCardView;->setBackground(Landroid/graphics/drawable/Drawable;)V

    :cond_1
    sget v3, Landroidx/leanback/R$styleable;->lbBaseCardView_infoVisibility:I
    ...
    iput v3, p0, Landroidx/leanback/widget/BaseCardView;->mInfoVisibility:I

    sget v3, Landroidx/leanback/R$styleable;->lbBaseCardView_extraVisibility:I
    ...
    iput v3, p0, Landroidx/leanback/widget/BaseCardView;->mExtraVisibility:I

    iget v3, p0, Landroidx/leanback/widget/BaseCardView;->mExtraVisibility:I

    iget v5, p0, Landroidx/leanback/widget/BaseCardView;->mInfoVisibility:I

    if-ge v3, v5, :cond_2

    iget v3, p0, Landroidx/leanback/widget/BaseCardView;->mInfoVisibility:I

    iput v3, p0, Landroidx/leanback/widget/BaseCardView;->mExtraVisibility:I

    :cond_2
    sget v3, Landroidx/leanback/R$styleable;->lbBaseCardView_selectedAnimationDelay:I

    invoke-virtual {p0}, Landroidx/leanback/widget/BaseCardView;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    sget v6, Landroidx/leanback/R$integer;->lb_card_selected_animation_delay:I
    ...
    sget v3, Landroidx/leanback/R$styleable;->lbBaseCardView_selectedAnimationDuration:I

    invoke-virtual {p0}, Landroidx/leanback/widget/BaseCardView;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    sget v6, Landroidx/leanback/R$integer;->lb_card_selected_animation_duration:I
    ...
    sget v3, Landroidx/leanback/R$styleable;->lbBaseCardView_activatedAnimationDuration:I

    invoke-virtual {p0}, Landroidx/leanback/widget/BaseCardView;->getResources()Landroid/content/res/Resources;

    move-result-object v5

    sget v6, Landroidx/leanback/R$integer;->lb_card_activated_animation_duration:I
    ...
    iput v3, p0, Landroidx/leanback/widget/BaseCardView;->mActivatedAnimDuration:I
    :try_end_0
    ...
    iput-boolean v4, p0, Landroidx/leanback/widget/BaseCardView;->mDelaySelectedAnim:Z

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mMainViewList:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mInfoViewList:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mExtraViewList:Ljava/util/ArrayList;

    const/4 v1, 0x0

    iput v1, p0, Landroidx/leanback/widget/BaseCardView;->mInfoOffset:F

    invoke-virtual {p0}, Landroidx/leanback/widget/BaseCardView;->getFinalInfoVisFraction()F

    move-result v1

    iput v1, p0, Landroidx/leanback/widget/BaseCardView;->mInfoVisFraction:F

    invoke-virtual {p0}, Landroidx/leanback/widget/BaseCardView;->getFinalInfoAlpha()F

    move-result v1

    iput v1, p0, Landroidx/leanback/widget/BaseCardView;->mInfoAlpha:F
...
.method private animateInfoAlpha(Z)V
    ...
    :cond_2
    new-instance v3, Landroidx/leanback/widget/BaseCardView$InfoAlphaAnimation;

    iget v4, p0, Landroidx/leanback/widget/BaseCardView;->mInfoAlpha:F
    ...
    :goto_2
    invoke-direct {v3, p0, v4, v0}, Landroidx/leanback/widget/BaseCardView$InfoAlphaAnimation;-><init>(Landroidx/leanback/widget/BaseCardView;FF)V

    iput-object v3, p0, Landroidx/leanback/widget/BaseCardView;->mAnim:Landroid/view/animation/Animation;

    iget-object v0, p0, Landroidx/leanback/widget/BaseCardView;->mAnim:Landroid/view/animation/Animation;

    iget v1, p0, Landroidx/leanback/widget/BaseCardView;->mActivatedAnimDuration:I
    ...
    new-instance v1, Landroidx/leanback/widget/BaseCardView$4;

    invoke-direct {v1, p0}, Landroidx/leanback/widget/BaseCardView$4;-><init>(Landroidx/leanback/widget/BaseCardView;)V

    invoke-virtual {v0, v1}, Landroid/view/animation/Animation;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V

    iget-object v0, p0, Landroidx/leanback/widget/BaseCardView;->mAnim:Landroid/view/animation/Animation;

    invoke-virtual {p0, v0}, Landroidx/leanback/widget/BaseCardView;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private animateInfoHeight(Z)V
    ...
    invoke-direct {v1, p0, v2, v0}, Landroidx/leanback/widget/BaseCardView$InfoHeightAnimation;-><init>(Landroidx/leanback/widget/BaseCardView;FF)V

    iput-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mAnim:Landroid/view/animation/Animation;

    iget-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mAnim:Landroid/view/animation/Animation;

    iget v2, p0, Landroidx/leanback/widget/BaseCardView;->mSelectedAnimDuration:I
    ...
    new-instance v2, Landroidx/leanback/widget/BaseCardView$3;

    invoke-direct {v2, p0}, Landroidx/leanback/widget/BaseCardView$3;-><init>(Landroidx/leanback/widget/BaseCardView;)V

    invoke-virtual {v1, v2}, Landroid/view/animation/Animation;->setAnimationListener(Landroid/view/animation/Animation$AnimationListener;)V

    iget-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mAnim:Landroid/view/animation/Animation;

    invoke-virtual {p0, v1}, Landroidx/leanback/widget/BaseCardView;->startAnimation(Landroid/view/animation/Animation;)V
...
.method private applySelectedState(Z)V
    ...
    invoke-virtual {p0, v0}, Landroidx/leanback/widget/BaseCardView;->post(Ljava/lang/Runnable;)Z
    ...
    iget v1, p0, Landroidx/leanback/widget/BaseCardView;->mSelectedAnimationDelay:I

    int-to-long v1, v1

    invoke-virtual {p0, v0, v1, v2}, Landroidx/leanback/widget/BaseCardView;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private findChildrenViews()V
    ...
    iget v8, p0, Landroidx/leanback/widget/BaseCardView;->mInfoAlpha:F

    invoke-virtual {v6, v8}, Landroid/view/View;->setAlpha(F)V

    iget-object v8, p0, Landroidx/leanback/widget/BaseCardView;->mInfoViewList:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Landroidx/leanback/widget/BaseCardView;->mExtraViewList:Ljava/util/ArrayList;
    ...
    :cond_6
    iget-object v8, p0, Landroidx/leanback/widget/BaseCardView;->mMainViewList:Ljava/util/ArrayList;
...
.method private setInfoViewVisibility(Z)V
    ...
    :goto_2
    iget-object v1, p0, Landroidx/leanback/widget/BaseCardView;->mExtraViewList:Ljava/util/ArrayList;
    ...
    iput v0, p0, Landroidx/leanback/widget/BaseCardView;->mInfoOffset:F
...
.method animateInfoOffset(Z)V
    ...
    :goto_1
    invoke-direct {v1, p0, v2, v3}, Landroidx/leanback/widget/BaseCardView$InfoOffsetAnimation;-><init>(Landroidx/leanback/widget/BaseCardView;FF)V
    ...
    new-instance v2, Landroidx/leanback/widget/BaseCardView$2;

    invoke-direct {v2, p0}, Landroidx/leanback/widget/BaseCardView$2;-><init>(Landroidx/leanback/widget/BaseCardView;)V
...
.method protected generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroidx/leanback/widget/BaseCardView$LayoutParams;
    ...
    check-cast v1, Landroidx/leanback/widget/BaseCardView$LayoutParams;

    invoke-direct {v0, v1}, Landroidx/leanback/widget/BaseCardView$LayoutParams;-><init>(Landroidx/leanback/widget/BaseCardView$LayoutParams;)V
...
.method protected onCreateDrawableState(I)[I
    ...
    sget-object v4, Landroidx/leanback/widget/BaseCardView;->LB_PRESSED_STATE_SET:[I
...
.method protected onLayout(ZIIII)V
    ...
    :goto_0
    iget-object v3, v0, Landroidx/leanback/widget/BaseCardView;->mMainViewList:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroidx/leanback/widget/BaseCardView;->mMeasuredWidth:I
    ...
    :goto_1
    iget-object v5, v0, Landroidx/leanback/widget/BaseCardView;->mInfoViewList:Ljava/util/ArrayList;
    ...
    :cond_4
    iget v3, v0, Landroidx/leanback/widget/BaseCardView;->mInfoOffset:F
    ...
    :goto_3
    iget-object v6, v0, Landroidx/leanback/widget/BaseCardView;->mInfoViewList:Ljava/util/ArrayList;
    ...
    iget v10, v0, Landroidx/leanback/widget/BaseCardView;->mMeasuredWidth:I
    ...
    :goto_5
    iget-object v5, v0, Landroidx/leanback/widget/BaseCardView;->mExtraViewList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v4, v4, v2, v3}, Landroidx/leanback/widget/BaseCardView;->onSizeChanged(IIII)V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {p0, v7, v5, v5}, Landroidx/leanback/widget/BaseCardView;->measureChild(Landroid/view/View;II)V

    iget v8, p0, Landroidx/leanback/widget/BaseCardView;->mMeasuredWidth:I
    ...
    iput v8, p0, Landroidx/leanback/widget/BaseCardView;->mMeasuredWidth:I
    ...
    invoke-static {v1, v8}, Landroid/view/View;->combineMeasuredStates(II)I
    ...
    invoke-virtual {p0, v6}, Landroidx/leanback/widget/BaseCardView;->setPivotX(F)V

    div-int/lit8 v6, v2, 0x2

    int-to-float v6, v6

    invoke-virtual {p0, v6}, Landroidx/leanback/widget/BaseCardView;->setPivotY(F)V
    ...
    :goto_1
    iget-object v11, p0, Landroidx/leanback/widget/BaseCardView;->mInfoViewList:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v11, v6, v5}, Landroidx/leanback/widget/BaseCardView;->measureChild(Landroid/view/View;II)V

    iget v12, p0, Landroidx/leanback/widget/BaseCardView;->mCardType:I
    ...
    iget v8, p0, Landroidx/leanback/widget/BaseCardView;->mInfoVisibility:I
    ...
    iget v9, p0, Landroidx/leanback/widget/BaseCardView;->mInfoVisFraction:F
    ...
    :cond_9
    iget v8, p0, Landroidx/leanback/widget/BaseCardView;->mInfoOffset:F
    ...
    iput v7, p0, Landroidx/leanback/widget/BaseCardView;->mMeasuredHeight:I

    iget v7, p0, Landroidx/leanback/widget/BaseCardView;->mMeasuredWidth:I
    ...
    invoke-static {v7, p1, v1}, Landroid/view/View;->resolveSizeAndState(III)I

    move-result v7

    iget v8, p0, Landroidx/leanback/widget/BaseCardView;->mMeasuredHeight:I
    ...
    invoke-static {v8, p2, v9}, Landroid/view/View;->resolveSizeAndState(III)I

    move-result v8

    invoke-virtual {p0, v7, v8}, Landroidx/leanback/widget/BaseCardView;->setMeasuredDimension(II)V
...
.method public setActivated(Z)V
    ...
    invoke-direct {p0, v0}, Landroidx/leanback/widget/BaseCardView;->applyActiveState(Z)V
...
.method public setCardType(I)V
    ...
    const-string v1, ". Defaulting to type CARD_TYPE_MAIN_ONLY."
    ...
    iput v0, p0, Landroidx/leanback/widget/BaseCardView;->mCardType:I
...
.method public setInfoVisibility(I)V
    ...
    iput v0, p0, Landroidx/leanback/widget/BaseCardView;->mInfoAlpha:F
...
.method public setSelected(Z)V
    ...
    invoke-direct {p0, v0}, Landroidx/leanback/widget/BaseCardView;->applySelectedState(Z)V
