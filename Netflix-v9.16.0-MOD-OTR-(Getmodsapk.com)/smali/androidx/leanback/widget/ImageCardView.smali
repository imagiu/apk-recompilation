...
.method private buildImageCardView(Landroid/util/AttributeSet;II)V
    ...
    sget v3, Landroidx/leanback/R$layout;->lb_image_card_view:I
    ...
    sget v4, Landroidx/leanback/R$styleable;->lbImageCardView_lbImageCardViewType:I
    ...
    invoke-virtual {v0, v14}, Landroidx/leanback/widget/ImageCardView;->findViewById(I)Landroid/view/View;

    move-result-object v14

    check-cast v14, Landroid/widget/ImageView;

    iput-object v14, v0, Landroidx/leanback/widget/ImageCardView;->mImageView:Landroid/widget/ImageView;

    iget-object v14, v0, Landroidx/leanback/widget/ImageCardView;->mImageView:Landroid/widget/ImageView;
    ...
    :cond_5
    iget-object v13, v0, Landroidx/leanback/widget/ImageCardView;->mImageView:Landroid/widget/ImageView;
    ...
    iput-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mFadeInAnimator:Landroid/animation/ObjectAnimator;

    iget-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mFadeInAnimator:Landroid/animation/ObjectAnimator;
    ...
    invoke-virtual {v0, v1}, Landroidx/leanback/widget/ImageCardView;->findViewById(I)Landroid/view/View;

    move-result-object v1

    check-cast v1, Landroid/view/ViewGroup;

    iput-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mInfoArea:Landroid/view/ViewGroup;

    if-eqz v9, :cond_6

    iget-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mInfoArea:Landroid/view/ViewGroup;

    invoke-virtual {v0, v1}, Landroidx/leanback/widget/ImageCardView;->removeView(Landroid/view/View;)V
    ...
    iget-object v13, v0, Landroidx/leanback/widget/ImageCardView;->mInfoArea:Landroid/view/ViewGroup;
    ...
    iput-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mTitleView:Landroid/widget/TextView;

    iget-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mInfoArea:Landroid/view/ViewGroup;

    iget-object v13, v0, Landroidx/leanback/widget/ImageCardView;->mTitleView:Landroid/widget/TextView;
    ...
    iput-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mContentView:Landroid/widget/TextView;

    iget-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mInfoArea:Landroid/view/ViewGroup;

    iget-object v13, v0, Landroidx/leanback/widget/ImageCardView;->mContentView:Landroid/widget/TextView;
    ...
    iput-object v8, v0, Landroidx/leanback/widget/ImageCardView;->mBadgeImage:Landroid/widget/ImageView;

    iget-object v8, v0, Landroidx/leanback/widget/ImageCardView;->mInfoArea:Landroid/view/ViewGroup;

    iget-object v13, v0, Landroidx/leanback/widget/ImageCardView;->mBadgeImage:Landroid/widget/ImageView;
    ...
    iget-object v14, v0, Landroidx/leanback/widget/ImageCardView;->mBadgeImage:Landroid/widget/ImageView;
    ...
    :goto_5
    iget-object v14, v0, Landroidx/leanback/widget/ImageCardView;->mTitleView:Landroid/widget/TextView;
    ...
    invoke-virtual {v13, v8}, Landroid/widget/RelativeLayout$LayoutParams;->removeRule(I)V

    const/16 v8, 0x14

    invoke-virtual {v13, v8}, Landroid/widget/RelativeLayout$LayoutParams;->removeRule(I)V

    iget-object v8, v0, Landroidx/leanback/widget/ImageCardView;->mBadgeImage:Landroid/widget/ImageView;
    ...
    :cond_f
    iget-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mContentView:Landroid/widget/TextView;

    invoke-virtual {v1, v13}, Landroid/widget/TextView;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    :cond_10
    iget-object v1, v0, Landroidx/leanback/widget/ImageCardView;->mBadgeImage:Landroid/widget/ImageView;
    ...
    iget-object v8, v0, Landroidx/leanback/widget/ImageCardView;->mContentView:Landroid/widget/TextView;
    ...
    iget-object v8, v0, Landroidx/leanback/widget/ImageCardView;->mTitleView:Landroid/widget/TextView;
    ...
    invoke-virtual {v0, v1}, Landroidx/leanback/widget/ImageCardView;->setInfoAreaBackground(Landroid/graphics/drawable/Drawable;)V
