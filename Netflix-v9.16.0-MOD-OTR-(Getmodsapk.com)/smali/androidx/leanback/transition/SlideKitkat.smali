...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v1}, Landroidx/leanback/transition/SlideKitkat;->setSlideEdge(I)V

    sget v2, Landroidx/leanback/R$styleable;->lbSlide_android_duration:I
    ...
    invoke-virtual {p0, v4, v5}, Landroidx/leanback/transition/SlideKitkat;->setDuration(J)Landroid/transition/Transition;

    :cond_0
    sget v2, Landroidx/leanback/R$styleable;->lbSlide_android_startDelay:I
    ...
    invoke-virtual {p0, v2, v3}, Landroidx/leanback/transition/SlideKitkat;->setStartDelay(J)Landroid/transition/Transition;

    :cond_1
    sget v6, Landroidx/leanback/R$styleable;->lbSlide_android_interpolator:I
    ...
    invoke-virtual {p0, v7}, Landroidx/leanback/transition/SlideKitkat;->setInterpolator(Landroid/animation/TimeInterpolator;)Landroid/transition/Transition;
...
.method private createAnimation(Landroid/view/View;Landroid/util/Property;FFFLandroid/animation/TimeInterpolator;I)Landroid/animation/Animator;
    ...
    :goto_0
    sget v3, Landroidx/leanback/R$id;->lb_slide_transition_value:I
    ...
    new-instance v11, Landroidx/leanback/transition/SlideKitkat$SlideAnimatorListener;
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/transition/TransitionValues;ILandroid/transition/TransitionValues;I)Landroid/animation/Animator;
    ...
    :cond_1
    iget-object v0, v8, Landroidx/leanback/transition/SlideKitkat;->mSlideCalculator:Landroidx/leanback/transition/SlideKitkat$CalculateSlide;

    invoke-interface {v0, v10}, Landroidx/leanback/transition/SlideKitkat$CalculateSlide;->getHere(Landroid/view/View;)F

    move-result v11

    iget-object v0, v8, Landroidx/leanback/transition/SlideKitkat;->mSlideCalculator:Landroidx/leanback/transition/SlideKitkat$CalculateSlide;

    invoke-interface {v0, v10}, Landroidx/leanback/transition/SlideKitkat$CalculateSlide;->getGone(Landroid/view/View;)F

    move-result v12

    iget-object v0, v8, Landroidx/leanback/transition/SlideKitkat;->mSlideCalculator:Landroidx/leanback/transition/SlideKitkat$CalculateSlide;

    invoke-interface {v0}, Landroidx/leanback/transition/SlideKitkat$CalculateSlide;->getProperty()Landroid/util/Property;
