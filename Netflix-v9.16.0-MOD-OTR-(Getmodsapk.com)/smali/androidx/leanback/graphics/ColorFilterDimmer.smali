...
.method private constructor <init>(Landroidx/leanback/graphics/ColorFilterCache;FF)V
    ...
    iput p3, p0, Landroidx/leanback/graphics/ColorFilterDimmer;->mDimmedLevel:F

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0}, Landroid/graphics/Paint;-><init>()V

    iput-object v0, p0, Landroidx/leanback/graphics/ColorFilterDimmer;->mPaint:Landroid/graphics/Paint;
...
.method public static createDefault(Landroid/content/Context;)Landroidx/leanback/graphics/ColorFilterDimmer;
    ...
    sget v5, Landroidx/leanback/R$fraction;->lb_view_dimmed_level:I

    invoke-virtual {v4, v5, v6, v6}, Landroid/content/res/Resources;->getFraction(III)F

    move-result v4

    invoke-virtual {v0, v3, v6, v6, v4}, Landroid/content/res/TypedArray;->getFraction(IIIF)F

    move-result v3

    invoke-virtual {v0}, Landroid/content/res/TypedArray;->recycle()V

    new-instance v4, Landroidx/leanback/graphics/ColorFilterDimmer;
    ...
    invoke-direct {v4, v5, v2, v3}, Landroidx/leanback/graphics/ColorFilterDimmer;-><init>(Landroidx/leanback/graphics/ColorFilterCache;FF)V
...
.method public setActiveLevel(F)V
    ...
    iput-object v0, p0, Landroidx/leanback/graphics/ColorFilterDimmer;->mFilter:Landroid/graphics/ColorFilter;

    iget-object v0, p0, Landroidx/leanback/graphics/ColorFilterDimmer;->mPaint:Landroid/graphics/Paint;

    iget-object v1, p0, Landroidx/leanback/graphics/ColorFilterDimmer;->mFilter:Landroid/graphics/ColorFilter;
