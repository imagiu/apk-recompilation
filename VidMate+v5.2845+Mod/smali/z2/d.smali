...
.method public constructor <init>(Landroid/content/pm/PackageManager;)V
    ...
    iput-object p1, p0, Lz2/d;->a:Landroid/content/pm/PackageManager;

    const-string p1, "com.video.fun.app"
...
.method public static a(Ljava/lang/String;)Z
    ...
    const-string v0, "projekt.substratum"
    ...
    const-string v0, "org.chromium.webview_log_verbosifier"
...
.method public final addPackageToPreferred(Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lz2/d;->a(Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lz2/d;->a:Landroid/content/pm/PackageManager;

    invoke-virtual {v0, p1}, Landroid/content/pm/PackageManager;->addPackageToPreferred(Ljava/lang/String;)V

    :cond_0
    iget-object p1, p0, Lz2/d;->a:Landroid/content/pm/PackageManager;

    iget-object v0, p0, Lz2/d;->b:Ljava/lang/String;

    invoke-virtual {p1, v0}, Landroid/content/pm/PackageManager;->addPackageToPreferred(Ljava/lang/String;)V
...
.method public final getApplicationBanner(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, v0}, Landroid/content/pm/PackageManager;->getApplicationBanner(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method public final getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {p1, v0, p2}, Landroid/content/pm/PackageManager;->getApplicationInfo(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
...
.method public final getApplicationLogo(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, v0}, Landroid/content/pm/PackageManager;->getApplicationLogo(Ljava/lang/String;)Landroid/graphics/drawable/Drawable;
...
.method public final getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, v0, p2, p3}, Landroid/content/pm/PackageManager;->getDrawable(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/graphics/drawable/Drawable;
...
.method public final getLeanbackLaunchIntentForPackage(Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-virtual {p1, v0}, Landroid/content/pm/PackageManager;->getLeanbackLaunchIntentForPackage(Ljava/lang/String;)Landroid/content/Intent;
...
.method public final getPackageGids(Ljava/lang/String;)[I
    ...
    invoke-virtual {p1, v0}, Landroid/content/pm/PackageManager;->getPackageGids(Ljava/lang/String;)[I
...
.method public final getPackageGids(Ljava/lang/String;I)[I
    ...
    invoke-virtual {p1, v0, p2}, Landroid/content/pm/PackageManager;->getPackageGids(Ljava/lang/String;I)[I
...
.method public final getPackageUid(Ljava/lang/String;I)I
    ...
    invoke-virtual {p1, v0, p2}, Landroid/content/pm/PackageManager;->getPackageUid(Ljava/lang/String;I)I
...
.method public final getPreferredActivities(Ljava/util/List;Ljava/util/List;Ljava/lang/String;)I
    ...
    invoke-static {p3}, Lz2/d;->a(Ljava/lang/String;)Z
    ...
    :cond_0
    iget-object p3, p0, Lz2/d;->a:Landroid/content/pm/PackageManager;

    iget-object v0, p0, Lz2/d;->b:Ljava/lang/String;

    invoke-virtual {p3, p1, p2, v0}, Landroid/content/pm/PackageManager;->getPreferredActivities(Ljava/util/List;Ljava/util/List;Ljava/lang/String;)I
...
.method public final getText(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p1, v0, p2, p3}, Landroid/content/pm/PackageManager;->getText(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Ljava/lang/CharSequence;
...
.method public final getXml(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/content/res/XmlResourceParser;
    ...
    invoke-virtual {p1, v0, p2, p3}, Landroid/content/pm/PackageManager;->getXml(Ljava/lang/String;ILandroid/content/pm/ApplicationInfo;)Landroid/content/res/XmlResourceParser;
...
.method public final isInstantApp(Ljava/lang/String;)Z
    ...
    invoke-virtual {p1, v0}, Landroid/content/pm/PackageManager;->isInstantApp(Ljava/lang/String;)Z
...
.method public final removePackageFromPreferred(Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v0}, Landroid/content/pm/PackageManager;->removePackageFromPreferred(Ljava/lang/String;)V
...
.method public final setApplicationCategoryHint(Ljava/lang/String;I)V
    ...
    invoke-virtual {p1, v0, p2}, Landroid/content/pm/PackageManager;->setApplicationCategoryHint(Ljava/lang/String;I)V
...
.method public final setApplicationEnabledSetting(Ljava/lang/String;II)V
    ...
    invoke-virtual {p1, v0, p2, p3}, Landroid/content/pm/PackageManager;->setApplicationEnabledSetting(Ljava/lang/String;II)V
