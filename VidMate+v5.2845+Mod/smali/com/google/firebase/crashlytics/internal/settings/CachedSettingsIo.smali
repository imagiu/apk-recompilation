...
.method public readCachedSettings()Lorg/json/JSONObject;
    ...
    new-instance v3, Lcom/google/firebase/crashlytics/internal/persistence/FileStoreImpl;

    iget-object v4, p0, Lcom/google/firebase/crashlytics/internal/settings/CachedSettingsIo;->a:Landroid/content/Context;

    invoke-direct {v3, v4}, Lcom/google/firebase/crashlytics/internal/persistence/FileStoreImpl;-><init>(Landroid/content/Context;)V

    invoke-virtual {v3}, Lcom/google/firebase/crashlytics/internal/persistence/FileStoreImpl;->getFilesDir()Ljava/io/File;
...
.method public writeCachedSettings(JLorg/json/JSONObject;)V
    ...
    new-instance v2, Lcom/google/firebase/crashlytics/internal/persistence/FileStoreImpl;

    iget-object v3, p0, Lcom/google/firebase/crashlytics/internal/settings/CachedSettingsIo;->a:Landroid/content/Context;

    invoke-direct {v2, v3}, Lcom/google/firebase/crashlytics/internal/persistence/FileStoreImpl;-><init>(Landroid/content/Context;)V

    invoke-virtual {v2}, Lcom/google/firebase/crashlytics/internal/persistence/FileStoreImpl;->getFilesDir()Ljava/io/File;
