...
.method private getBigPictureStyleTask(Ljava/util/concurrent/Executor;)Lcom/google/android/gms/tasks/Task;
    .locals 1
...
.method private getMessagingStyleTask(Ljava/util/concurrent/Executor;)Lcom/google/android/gms/tasks/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Lapp/notifee/core/model/NotificationAndroidStyleModel$$ExternalSyntheticLambda2;-><init>(Lapp/notifee/core/model/NotificationAndroidStyleModel;Ljava/util/concurrent/Executor;)V
...
.method private static getPerson(Ljava/util/concurrent/Executor;Landroid/os/Bundle;)Lcom/google/android/gms/tasks/Task;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Lapp/notifee/core/model/NotificationAndroidStyleModel$$ExternalSyntheticLambda1;-><init>(Landroid/os/Bundle;)V
...
.method static synthetic lambda$getPerson$0(Landroid/os/Bundle;)Landroidx/core/app/Person;
    ...
    .line 24
    :try_start_0
    invoke-static {v2}, Ln/o/t/i/f/e/e/n;->a(Ljava/lang/String;)Lcom/google/android/gms/tasks/Task;
...
# virtual methods
.method public getStyleTask(Ljava/util/concurrent/Executor;)Lcom/google/android/gms/tasks/Task;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 15
    :cond_0
    invoke-direct {p0, p1}, Lapp/notifee/core/model/NotificationAndroidStyleModel;->getMessagingStyleTask(Ljava/util/concurrent/Executor;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 18
    :cond_3
    invoke-direct {p0, p1}, Lapp/notifee/core/model/NotificationAndroidStyleModel;->getBigPictureStyleTask(Ljava/util/concurrent/Executor;)Lcom/google/android/gms/tasks/Task;
...
.method lambda$getBigPictureStyleTask$1$app-notifee-core-model-NotificationAndroidStyleModel()Landroidx/core/app/NotificationCompat$Style;
    ...
    invoke-static {v2, v3, v4, v7}, Lcom/google/android/gms/tasks/Tasks;->await(Lcom/google/android/gms/tasks/Task;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
...
.method lambda$getMessagingStyleTask$2$app-notifee-core-model-NotificationAndroidStyleModel(Ljava/util/concurrent/Executor;)Landroidx/core/app/NotificationCompat$Style;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    .line 6
    invoke-static {p1, v0}, Lapp/notifee/core/model/NotificationAndroidStyleModel;->getPerson(Ljava/util/concurrent/Executor;Landroid/os/Bundle;)Lcom/google/android/gms/tasks/Task;
    ...
    invoke-static {v8}, Ln/o/t/i/f/e/e/l;->b(Ljava/lang/Object;)J
    ...
    invoke-static {p1, v10}, Lapp/notifee/core/model/NotificationAndroidStyleModel;->getPerson(Ljava/util/concurrent/Executor;Landroid/os/Bundle;)Lcom/google/android/gms/tasks/Task;
    ...
    .line 46
    invoke-static {v10, v3, v4, v11}, Lcom/google/android/gms/tasks/Tasks;->await(Lcom/google/android/gms/tasks/Task;JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
