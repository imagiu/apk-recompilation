.class public Landroidx/test/internal/events/client/TestPlatformEventServiceConnection;
.super Landroidx/test/internal/events/client/TestEventServiceConnectionBase;
.source "TestPlatformEventServiceConnection.java"

# interfaces
.implements Landroidx/test/internal/events/client/TestPlatformEventService;
...
.annotation system Ldalvik/annotation/Signature;
    value = {
        ...
        "Landroidx/test/services/events/platform/ITestPlatformEvent;",
        ">;",
        "Landroidx/test/internal/events/client/TestPlatformEventService;"
    }
.end annotation
...
.method constructor <init>(Ljava/lang/String;Landroidx/test/internal/events/client/TestEventClientConnectListener;)V
    ...
    .line 32
    sget-object v0, Landroidx/test/internal/events/client/TestPlatformEventServiceConnection$$Lambda$0;->$instance:Landroidx/test/internal/events/client/TestEventServiceConnectionBase$ServiceFromBinder;
...
.method public send(Landroidx/test/services/events/platform/TestPlatformEvent;)V
    ...
    .line 38
    const-string/jumbo v0, "testPlatformEvent cannot be null"
    ...
    .line 39
    iget-object v0, p0, Landroidx/test/internal/events/client/TestPlatformEventServiceConnection;->service:Landroid/os/IInterface;
    ...
    invoke-interface {v0, p1}, Landroidx/test/services/events/platform/ITestPlatformEvent;->send(Landroidx/test/services/events/platform/TestPlatformEvent;)V
    :try_end_0
    ...
    const-string v1, "Failed to send test platform event"
    ...
    const-string v0, "Can\'t send test platform event, service not connected"
