...
.method private expandIfNecessary(J)V
    ...
    .line 443
    invoke-direct/range {p0 .. p0}, Lio/sentry/cache/tape/QueueFile;->remainingBytes()J
    ...
    .line 447
    :cond_0
    iget-wide v6, v8, Lio/sentry/cache/tape/QueueFile;->fileLength:J
    ...
    .line 456
    invoke-direct {v8, v9, v10}, Lio/sentry/cache/tape/QueueFile;->setLength(J)V

    .line 459
    iget-object v2, v8, Lio/sentry/cache/tape/QueueFile;->last:Lio/sentry/cache/tape/QueueFile$Element;

    iget-wide v2, v2, Lio/sentry/cache/tape/QueueFile$Element;->position:J

    add-long/2addr v2, v0

    iget-object v0, v8, Lio/sentry/cache/tape/QueueFile;->last:Lio/sentry/cache/tape/QueueFile$Element;
    ...
    invoke-virtual {v8, v2, v3}, Lio/sentry/cache/tape/QueueFile;->wrapPosition(J)J

    move-result-wide v0

    .line 462
    iget-object v2, v8, Lio/sentry/cache/tape/QueueFile;->first:Lio/sentry/cache/tape/QueueFile$Element;
    ...
    .line 463
    iget-object v2, v8, Lio/sentry/cache/tape/QueueFile;->raf:Ljava/io/RandomAccessFile;
    ...
    .line 464
    iget-wide v3, v8, Lio/sentry/cache/tape/QueueFile;->fileLength:J
    ...
    .line 473
    iget-wide v0, v8, Lio/sentry/cache/tape/QueueFile;->fileLength:J
    ...
    .line 474
    iget v3, v8, Lio/sentry/cache/tape/QueueFile;->elementCount:I

    iget-object v0, v8, Lio/sentry/cache/tape/QueueFile;->first:Lio/sentry/cache/tape/QueueFile$Element;
    ...
    iget-object v1, v8, Lio/sentry/cache/tape/QueueFile;->last:Lio/sentry/cache/tape/QueueFile$Element;

    iget v1, v1, Lio/sentry/cache/tape/QueueFile$Element;->length:I

    move-wide/from16 v2, p1

    invoke-direct {v0, v2, v3, v1}, Lio/sentry/cache/tape/QueueFile$Element;-><init>(JI)V

    iput-object v0, v8, Lio/sentry/cache/tape/QueueFile;->last:Lio/sentry/cache/tape/QueueFile$Element;
    ...
    iget-wide v6, v0, Lio/sentry/cache/tape/QueueFile$Element;->position:J
    ...
    .line 480
    :goto_2
    iput-wide v9, v8, Lio/sentry/cache/tape/QueueFile;->fileLength:J

    .line 482
    iget-boolean v0, v8, Lio/sentry/cache/tape/QueueFile;->zero:Z

    if-eqz v0, :cond_4

    .line 483
    invoke-direct {v8, v11, v12, v13, v14}, Lio/sentry/cache/tape/QueueFile;->ringErase(JJ)V
...
.method public add([BII)V
    ...
    .line 377
    iget-boolean v0, v8, Lio/sentry/cache/tape/QueueFile;->closed:Z
    ...
    .line 384
    invoke-direct {p0, v0, v1}, Lio/sentry/cache/tape/QueueFile;->expandIfNecessary(J)V
    ...
    invoke-virtual {p0, v0, v1}, Lio/sentry/cache/tape/QueueFile;->wrapPosition(J)J

    move-result-wide v0

    .line 390
    :goto_0
    new-instance v12, Lio/sentry/cache/tape/QueueFile$Element;

    invoke-direct {v12, v0, v1, v7}, Lio/sentry/cache/tape/QueueFile$Element;-><init>(JI)V

    .line 393
    iget-object v0, v8, Lio/sentry/cache/tape/QueueFile;->buffer:[B

    const/4 v1, 0x0

    invoke-static {v0, v1, v7}, Lio/sentry/cache/tape/QueueFile;->writeInt([BII)V

    .line 394
    iget-wide v1, v12, Lio/sentry/cache/tape/QueueFile$Element;->position:J

    iget-object v3, v8, Lio/sentry/cache/tape/QueueFile;->buffer:[B
    ...
    .line 397
    iget-wide v0, v12, Lio/sentry/cache/tape/QueueFile$Element;->position:J
    ...
    .line 401
    iget-wide v1, v8, Lio/sentry/cache/tape/QueueFile;->fileLength:J

    iget v0, v8, Lio/sentry/cache/tape/QueueFile;->elementCount:I

    add-int/lit8 v3, v0, 0x1

    iget-wide v6, v12, Lio/sentry/cache/tape/QueueFile$Element;->position:J
    ...
    .line 402
    iput-object v12, v8, Lio/sentry/cache/tape/QueueFile;->last:Lio/sentry/cache/tape/QueueFile$Element;
    ...
    iput v0, v8, Lio/sentry/cache/tape/QueueFile;->elementCount:I

    .line 404
    iget v0, v8, Lio/sentry/cache/tape/QueueFile;->modCount:I

    add-int/lit8 v0, v0, 0x1

    iput v0, v8, Lio/sentry/cache/tape/QueueFile;->modCount:I

    if-eqz v9, :cond_3

    .line 405
    iput-object v12, v8, Lio/sentry/cache/tape/QueueFile;->first:Lio/sentry/cache/tape/QueueFile$Element;
...
.method public clear()V
    ...
    .line 678
    iget-boolean v0, p0, Lio/sentry/cache/tape/QueueFile;->zero:Z
    ...
    invoke-direct {p0, v2, v3}, Lio/sentry/cache/tape/QueueFile;->setLength(J)V

    .line 688
    :cond_1
    iput-wide v2, p0, Lio/sentry/cache/tape/QueueFile;->fileLength:J

    .line 689
    iget v0, p0, Lio/sentry/cache/tape/QueueFile;->modCount:I
...
.method readElement(J)Lio/sentry/cache/tape/QueueFile$Element;
    ...
    invoke-direct {v1, p1, p2, v0}, Lio/sentry/cache/tape/QueueFile$Element;-><init>(JI)V
...
.method public remove(I)V
    ...
    .line 633
    invoke-virtual/range {p0 .. p0}, Lio/sentry/cache/tape/QueueFile;->clear()V

    return-void

    .line 636
    :cond_1
    invoke-virtual/range {p0 .. p0}, Lio/sentry/cache/tape/QueueFile;->isEmpty()Z
    ...
    iget-wide v10, v0, Lio/sentry/cache/tape/QueueFile$Element;->position:J
    ...
    .line 652
    invoke-virtual {v8, v12, v13}, Lio/sentry/cache/tape/QueueFile;->wrapPosition(J)J
    ...
    invoke-static {v0, v6}, Lio/sentry/cache/tape/QueueFile;->readInt([BI)I
    ...
    invoke-direct {v0, v12, v13, v14}, Lio/sentry/cache/tape/QueueFile$Element;-><init>(JI)V

    iput-object v0, v8, Lio/sentry/cache/tape/QueueFile;->first:Lio/sentry/cache/tape/QueueFile$Element;
    ...
    .line 667
    invoke-direct {v8, v10, v11, v3, v4}, Lio/sentry/cache/tape/QueueFile;->ringErase(JJ)V
    ...
    iget v2, v8, Lio/sentry/cache/tape/QueueFile;->elementCount:I
