...
.method private extractSamplingDecision(Lio/sentry/TraceContext;)Lio/sentry/TracesSamplingDecision;
    ...
    const-string v3, "Unable to parse sample rate from TraceContext: %s"

    filled-new-array {p1}, [Ljava/lang/Object;

    move-result-object p1

    invoke-interface {v1, v2, v3, p1}, Lio/sentry/ILogger;->log(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private processEnvelope(Lio/sentry/SentryEnvelope;Lio/sentry/Hint;)V
    ...
    invoke-direct {v3}, Lio/sentry/OutboxSender$$ExternalSyntheticLambda0;-><init>()V
...
.method protected processFile(Ljava/io/File;Lio/sentry/Hint;)V
    ...
    const-string v3, "Stream from path %s resulted in a null envelope."
    ...
    const-string v3, "File \'%s\' is done."
