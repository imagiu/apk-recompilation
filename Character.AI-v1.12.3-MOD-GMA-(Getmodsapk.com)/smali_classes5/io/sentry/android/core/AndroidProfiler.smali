...
.method public declared-synchronized start()Lio/sentry/android/core/AndroidProfiler$ProfileStartData;
    ...
    const-string v3, "Disabling profiling because intervaUs is set to %d"
    ...
    iget-object v3, p0, Lio/sentry/android/core/AndroidProfiler;->traceFilesDir:Ljava/io/File;
    ...
    new-instance v3, Lio/sentry/android/core/AndroidProfiler$1;

    invoke-direct {v3, p0}, Lio/sentry/android/core/AndroidProfiler$1;-><init>(Lio/sentry/android/core/AndroidProfiler;)V

    .line 144
    invoke-virtual {v0, v3}, Lio/sentry/android/core/internal/util/SentryFrameMetricsCollector;->startCollection(Lio/sentry/android/core/internal/util/SentryFrameMetricsCollector$FrameMetricsCollectorListener;)Ljava/lang/String;
    ...
    new-instance v3, Lio/sentry/android/core/AndroidProfiler$$ExternalSyntheticLambda0;

    invoke-direct {v3, p0}, Lio/sentry/android/core/AndroidProfiler$$ExternalSyntheticLambda0;-><init>(Lio/sentry/android/core/AndroidProfiler;)V

    const-wide/16 v4, 0x7530

    .line 189
    invoke-interface {v0, v3, v4, v5}, Lio/sentry/ISentryExecutorService;->schedule(Ljava/lang/Runnable;J)Ljava/util/concurrent/Future;
    ...
    iput-wide v3, p0, Lio/sentry/android/core/AndroidProfiler;->profileStartNanos:J
    ...
    iget v3, p0, Lio/sentry/android/core/AndroidProfiler;->intervalUs:I

    const v4, 0x2dc6c0

    invoke-static {v0, v4, v3}, Landroid/os/Debug;->startMethodTracingSampling(Ljava/lang/String;II)V
    ...
    invoke-direct/range {v5 .. v10}, Lio/sentry/android/core/AndroidProfiler$ProfileStartData;-><init>(JJLjava/util/Date;)V
    :try_end_6
