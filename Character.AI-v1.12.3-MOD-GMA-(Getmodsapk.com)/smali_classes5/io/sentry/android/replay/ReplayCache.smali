...
.method public final createVideoOf(JJIIIIILjava/io/File;)Lio/sentry/android/replay/GeneratedVideo;
    ...
    .line 150
    :cond_1
    iget-object v11, v1, Lio/sentry/android/replay/ReplayCache;->encoderLock:Ljava/lang/Object;
    ...
    .line 151
    invoke-direct/range {v4 .. v9}, Lio/sentry/android/replay/video/SimpleVideoEncoder;-><init>(Lio/sentry/SentryOptions;Lio/sentry/android/replay/video/MuxerConfig;Lkotlin/jvm/functions/Function0;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 166
    invoke-static {v2, v3, v7, v8}, Lkotlin/ranges/RangesKt;->until(JJ)Lkotlin/ranges/LongRange;

    move-result-object v2

    check-cast v2, Lkotlin/ranges/LongProgression;

    invoke-static {v2, v4, v5}, Lkotlin/ranges/RangesKt;->step(Lkotlin/ranges/LongProgression;J)Lkotlin/ranges/LongProgression;
    ...
    invoke-direct {v1, v13}, Lio/sentry/android/replay/ReplayCache;->deleteFile(Ljava/io/File;)V
    ...
    .line 204
    iget-object v4, v1, Lio/sentry/android/replay/ReplayCache;->encoderLock:Ljava/lang/Object;

    monitor-enter v4

    .line 205
    :try_start_2
    iget-object v5, v1, Lio/sentry/android/replay/ReplayCache;->encoder:Lio/sentry/android/replay/video/SimpleVideoEncoder;

    if-eqz v5, :cond_c

    invoke-virtual {v5}, Lio/sentry/android/replay/video/SimpleVideoEncoder;->release()V
    ...
    invoke-virtual {v5}, Lio/sentry/android/replay/video/SimpleVideoEncoder;->getDuration()J
    ...
    .line 207
    :goto_4
    iput-object v3, v1, Lio/sentry/android/replay/ReplayCache;->encoder:Lio/sentry/android/replay/video/SimpleVideoEncoder;
    ...
    .line 210
    invoke-virtual {v1, v7, v8}, Lio/sentry/android/replay/ReplayCache;->rotate(J)Ljava/lang/String;

    .line 212
    new-instance v3, Lio/sentry/android/replay/GeneratedVideo;

    invoke-direct {v3, v0, v2, v13, v14}, Lio/sentry/android/replay/GeneratedVideo;-><init>(Ljava/io/File;IJ)V
