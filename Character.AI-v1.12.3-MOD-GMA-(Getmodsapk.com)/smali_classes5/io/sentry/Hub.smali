...
.method private createTransaction(Lio/sentry/TransactionContext;Lio/sentry/TransactionOptions;)Lio/sentry/ITransaction;
    ...
    .line 788
    new-instance p2, Lio/sentry/Hub$$ExternalSyntheticLambda3;

    invoke-direct {p2, p1}, Lio/sentry/Hub$$ExternalSyntheticLambda3;-><init>(Lio/sentry/ITransaction;)V
...
.method public captureReplay(Lio/sentry/SentryReplayEvent;Lio/sentry/Hint;)Lio/sentry/protocol/SentryId;
    ...
    invoke-interface {v2, p1, v1, p2}, Lio/sentry/ISentryClient;->captureReplayEvent(Lio/sentry/SentryReplayEvent;Lio/sentry/IScope;Lio/sentry/Hint;)Lio/sentry/protocol/SentryId;
...
.method public close(Z)V
    ...
    .line 364
    :cond_2
    new-instance v0, Lio/sentry/Hub$$ExternalSyntheticLambda0;

    invoke-direct {v0}, Lio/sentry/Hub$$ExternalSyntheticLambda0;-><init>()V
    ...
    .line 369
    new-instance v2, Lio/sentry/Hub$$ExternalSyntheticLambda1;

    invoke-direct {v2, p0, v0}, Lio/sentry/Hub$$ExternalSyntheticLambda1;-><init>(Lio/sentry/Hub;Lio/sentry/ISentryExecutorService;)V
...
.method public continueTrace(Ljava/lang/String;Ljava/util/List;)Lio/sentry/TransactionContext;
    ...
    .line 883
    new-instance p2, Lio/sentry/Hub$$ExternalSyntheticLambda2;

    invoke-direct {p2, p1}, Lio/sentry/Hub$$ExternalSyntheticLambda2;-><init>(Lio/sentry/PropagationContext;)V
...
.method public endSession()V
    ...
    invoke-interface {v1}, Lio/sentry/IScope;->endSession()Lio/sentry/Session;
...
.method public getDefaultTagsForMetrics()Ljava/util/Map;
    ...
    invoke-interface {v1}, Lio/sentry/IScope;->getTransactionName()Ljava/lang/String;
...
.method public getLocalMetricsAggregator()Lio/sentry/metrics/LocalMetricsAggregator;
    ...
    .line 1030
    invoke-interface {v0}, Lio/sentry/ISpan;->getLocalMetricsAggregator()Lio/sentry/metrics/LocalMetricsAggregator;
...
.method public getMetricsAggregator()Lio/sentry/IMetricsAggregator;
    ...
    invoke-interface {v0}, Lio/sentry/ISentryClient;->getMetricsAggregator()Lio/sentry/IMetricsAggregator;
...
.method public metrics()Lio/sentry/metrics/MetricsApi;
    ...
    .line 982
    iget-object v0, p0, Lio/sentry/Hub;->metricsApi:Lio/sentry/metrics/MetricsApi;
...
.method public startSpanForMetric(Ljava/lang/String;Ljava/lang/String;)Lio/sentry/ISpan;
    ...
    .line 1018
    invoke-interface {v0, p1, p2}, Lio/sentry/ISpan;->startChild(Ljava/lang/String;Ljava/lang/String;)Lio/sentry/ISpan;
