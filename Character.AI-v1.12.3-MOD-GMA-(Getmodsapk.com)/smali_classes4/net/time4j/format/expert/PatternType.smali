...
.method private cldrISO(Lnet/time4j/format/expert/ChronoFormatter$Builder;Lnet/time4j/engine/Chronology;Ljava/util/Locale;CIZ)Ljava/util/Map;
    ...
    invoke-virtual {p1, v1, v6, v4}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addYear(Lnet/time4j/engine/ChronoElement;IZ)Lnet/time4j/format/expert/ChronoFormatter$Builder;

    goto/16 :goto_c

    .line 1685
    :pswitch_3
    invoke-static {p1, p4, v6, v4}, Lnet/time4j/format/expert/PatternType;->addOffset(Lnet/time4j/format/expert/ChronoFormatter$Builder;CIZ)V
    ...
    .line 1491
    :cond_5
    invoke-static {v2, p4, p1, v6, v7}, Lnet/time4j/format/expert/PatternType;->addNumber(Lnet/time4j/engine/ChronoElement;CLnet/time4j/format/expert/ChronoFormatter$Builder;IZ)V
    ...
    invoke-virtual {p1, v1, v6, v10}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addYear(Lnet/time4j/engine/ChronoElement;IZ)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    .line 1468
    invoke-static {p1, v6}, Lnet/time4j/format/expert/PatternType;->addQuarterOfYear(Lnet/time4j/format/expert/ChronoFormatter$Builder;I)V
    ...
    invoke-virtual {p1, v1, v6, v2, v3}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addLongNumber(Lnet/time4j/engine/ChronoElement;IILnet/time4j/format/expert/SignPolicy;)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    .line 1552
    invoke-virtual {p1, v1, v6}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addFixedNumerical(Lnet/time4j/engine/ChronoElement;I)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    .line 1566
    invoke-virtual {p1, v1, v10}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addFixedNumerical(Lnet/time4j/engine/ChronoElement;I)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    .line 1591
    :pswitch_10
    invoke-static/range {p5 .. p5}, Lnet/time4j/format/expert/PatternType;->getPeriodWidth(I)Lnet/time4j/format/TextWidth;
    ...
    .line 1643
    invoke-virtual {p1, v1, v4, v2}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addTimezoneOffset(Lnet/time4j/format/DisplayMode;ZLjava/util/List;)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    .line 1650
    invoke-virtual {p1, v1, v10, v2}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addTimezoneOffset(Lnet/time4j/format/DisplayMode;ZLjava/util/List;)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    .line 1682
    :pswitch_14
    invoke-static {p1, p4, v6, v10}, Lnet/time4j/format/expert/PatternType;->addOffset(Lnet/time4j/format/expert/ChronoFormatter$Builder;CIZ)V
    ...
    invoke-virtual {p1, v1, v10}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addFixedInteger(Lnet/time4j/engine/ChronoElement;I)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    invoke-virtual {p1, v1, v6, v6, v4}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addFraction(Lnet/time4j/engine/ChronoElement;IIZ)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    invoke-virtual {p1, v1, v6}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addFixedInteger(Lnet/time4j/engine/ChronoElement;I)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    invoke-virtual {p1, v1, v6, v5}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addInteger(Lnet/time4j/engine/ChronoElement;II)Lnet/time4j/format/expert/ChronoFormatter$Builder;
    ...
    invoke-virtual {p1, v1, v6, v2}, Lnet/time4j/format/expert/ChronoFormatter$Builder;->addInteger(Lnet/time4j/engine/ChronoElement;II)Lnet/time4j/format/expert/ChronoFormatter$Builder;
