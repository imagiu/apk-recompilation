...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v2, v3}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lnet/time4j/calendar/PersianMonth;->ORDIBEHESHT:Lnet/time4j/calendar/PersianMonth;

    .line 69
    new-instance v2, Lnet/time4j/calendar/PersianMonth;

    const-string v3, "KHORDAD"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lnet/time4j/calendar/PersianMonth;->KHORDAD:Lnet/time4j/calendar/PersianMonth;
    ...
    invoke-direct {v3, v4, v5}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lnet/time4j/calendar/PersianMonth;->TIR:Lnet/time4j/calendar/PersianMonth;

    .line 85
    new-instance v4, Lnet/time4j/calendar/PersianMonth;

    const-string v5, "MORDAD"

    const/4 v6, 0x4

    invoke-direct {v4, v5, v6}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v4, Lnet/time4j/calendar/PersianMonth;->MORDAD:Lnet/time4j/calendar/PersianMonth;
    ...
    invoke-direct {v5, v6, v7}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lnet/time4j/calendar/PersianMonth;->SHAHRIVAR:Lnet/time4j/calendar/PersianMonth;

    .line 101
    new-instance v6, Lnet/time4j/calendar/PersianMonth;

    const-string v7, "MEHR"

    const/4 v8, 0x6

    invoke-direct {v6, v7, v8}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v6, Lnet/time4j/calendar/PersianMonth;->MEHR:Lnet/time4j/calendar/PersianMonth;
    ...
    invoke-direct {v7, v8, v9}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lnet/time4j/calendar/PersianMonth;->ABAN:Lnet/time4j/calendar/PersianMonth;

    .line 117
    new-instance v8, Lnet/time4j/calendar/PersianMonth;

    const-string v9, "AZAR"

    const/16 v10, 0x8

    invoke-direct {v8, v9, v10}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v8, Lnet/time4j/calendar/PersianMonth;->AZAR:Lnet/time4j/calendar/PersianMonth;

    .line 125
    new-instance v9, Lnet/time4j/calendar/PersianMonth;

    const-string v10, "DEY"

    const/16 v11, 0x9

    invoke-direct {v9, v10, v11}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lnet/time4j/calendar/PersianMonth;->DEY:Lnet/time4j/calendar/PersianMonth;
    ...
    invoke-direct {v10, v11, v12}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v10, Lnet/time4j/calendar/PersianMonth;->BAHMAN:Lnet/time4j/calendar/PersianMonth;
    ...
    invoke-direct {v11, v12, v13}, Lnet/time4j/calendar/PersianMonth;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lnet/time4j/calendar/PersianMonth;->ESFAND:Lnet/time4j/calendar/PersianMonth;

    .line 42
    filled-new-array/range {v0 .. v11}, [Lnet/time4j/calendar/PersianMonth;

    move-result-object v0

    sput-object v0, Lnet/time4j/calendar/PersianMonth;->$VALUES:[Lnet/time4j/calendar/PersianMonth;
