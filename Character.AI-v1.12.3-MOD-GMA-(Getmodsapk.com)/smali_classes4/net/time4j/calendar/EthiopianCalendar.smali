...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lnet/time4j/calendar/EthiopianCalendar;->YEAR_OF_ERA:Lnet/time4j/calendar/StdCalendarElement;

    .line 236
    new-instance v2, Lnet/time4j/calendar/service/StdEnumDateElement;

    const-class v3, Lnet/time4j/calendar/EthiopianMonth;

    const/16 v5, 0x4d

    const-string v6, "MONTH_OF_YEAR"

    invoke-direct {v2, v6, v4, v3, v5}, Lnet/time4j/calendar/service/StdEnumDateElement;-><init>(Ljava/lang/String;Ljava/lang/Class;Ljava/lang/Class;C)V

    sput-object v2, Lnet/time4j/calendar/EthiopianCalendar;->MONTH_OF_YEAR:Lnet/time4j/calendar/StdCalendarElement;
    ...
    sput-object v3, Lnet/time4j/calendar/EthiopianCalendar;->DAY_OF_MONTH:Lnet/time4j/calendar/StdCalendarElement;
    ...
    invoke-direct {v6, v4, v7}, Lnet/time4j/calendar/service/StdWeekdayElement;-><init>(Ljava/lang/Class;Lnet/time4j/Weekmodel;)V
    ...
    invoke-direct {v7, v4, v3, v6}, Lnet/time4j/calendar/WeekdayInMonthElement;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;)V
    ...
    .line 353
    invoke-static {v11, v4, v12, v9}, Lnet/time4j/engine/TimeAxis$Builder;->setUp(Ljava/lang/Class;Ljava/lang/Class;Lnet/time4j/engine/ChronoMerger;Lnet/time4j/engine/CalendarSystem;)Lnet/time4j/engine/TimeAxis$Builder;
    ...
    .line 361
    invoke-virtual {v0, v1, v11, v12}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;Ljava/lang/Object;)Lnet/time4j/engine/TimeAxis$Builder;

    move-result-object v0

    new-instance v1, Lnet/time4j/calendar/EthiopianCalendar$MonthRule;

    invoke-direct {v1, v10}, Lnet/time4j/calendar/EthiopianCalendar$MonthRule;-><init>(Lnet/time4j/calendar/EthiopianCalendar$1;)V
    ...
    invoke-direct {v1, v2}, Lnet/time4j/calendar/EthiopianCalendar$IntegerRule;-><init>(I)V

    sget-object v2, Lnet/time4j/calendar/EthiopianCalendar$Unit;->DAYS:Lnet/time4j/calendar/EthiopianCalendar$Unit;
    ...
    invoke-direct {v1, v2, v11}, Lnet/time4j/calendar/WeekdayRule;-><init>(Lnet/time4j/Weekmodel;Lnet/time4j/engine/ChronoFunction;)V
    ...
    invoke-direct {v1, v10}, Lnet/time4j/calendar/EthiopianCalendar$EvangelistRule;-><init>(Lnet/time4j/calendar/EthiopianCalendar$1;)V

    .line 395
    invoke-virtual {v0, v14, v1}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/TimeAxis$Builder;

    move-result-object v0

    new-instance v1, Lnet/time4j/calendar/EthiopianCalendar$TabotRule;

    invoke-direct {v1, v10}, Lnet/time4j/calendar/EthiopianCalendar$TabotRule;-><init>(Lnet/time4j/calendar/EthiopianCalendar$1;)V
    ...
    invoke-direct {v13, v0}, Lnet/time4j/calendar/EthiopianCalendar$EthiopianUnitRule;-><init>(Lnet/time4j/calendar/EthiopianCalendar$Unit;)V
    ...
    invoke-direct {v8, v0}, Lnet/time4j/calendar/EthiopianCalendar$EthiopianUnitRule;-><init>(Lnet/time4j/calendar/EthiopianCalendar$Unit;)V
    ...
    invoke-direct {v1, v4, v3, v5, v2}, Lnet/time4j/calendar/CommonElements$Weekengine;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;Lnet/time4j/Weekmodel;)V
