...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lnet/time4j/calendar/ChineseCalendar;->LEAP_MONTHS:[I

    .line 322
    sget-object v0, Lnet/time4j/calendar/ChineseCalendar$EraElement;->INSTANCE:Lnet/time4j/calendar/ChineseCalendar$EraElement;

    sput-object v0, Lnet/time4j/calendar/ChineseCalendar;->ERA:Lnet/time4j/engine/ChronoElement;
    ...
    const-class v3, Lnet/time4j/calendar/ChineseCalendar;
    ...
    sput-object v9, Lnet/time4j/calendar/ChineseCalendar;->CYCLE:Lnet/time4j/engine/ChronoElement;
    ...
    const-class v12, Lnet/time4j/calendar/ChineseCalendar;
    ...
    sput-object v1, Lnet/time4j/calendar/ChineseCalendar;->YEAR_OF_ERA:Lnet/time4j/calendar/StdCalendarElement;

    .line 396
    sget-object v2, Lnet/time4j/calendar/EastAsianCY;->SINGLETON:Lnet/time4j/calendar/EastAsianCY;

    sput-object v2, Lnet/time4j/calendar/ChineseCalendar;->YEAR_OF_CYCLE:Lnet/time4j/format/TextElement;
    ...
    sput-object v3, Lnet/time4j/calendar/ChineseCalendar;->SOLAR_TERM:Lnet/time4j/engine/ChronoElement;

    .line 443
    sget-object v4, Lnet/time4j/calendar/EastAsianME;->SINGLETON_EA:Lnet/time4j/calendar/EastAsianME;

    sput-object v4, Lnet/time4j/calendar/ChineseCalendar;->MONTH_OF_YEAR:Lnet/time4j/format/TextElement;
    ...
    sput-object v5, Lnet/time4j/calendar/ChineseCalendar;->MONTH_AS_ORDINAL:Lnet/time4j/calendar/StdCalendarElement;
    ...
    const-class v20, Lnet/time4j/calendar/ChineseCalendar;
    ...
    sput-object v6, Lnet/time4j/calendar/ChineseCalendar;->DAY_OF_MONTH:Lnet/time4j/calendar/StdCalendarElement;
    ...
    sput-object v7, Lnet/time4j/calendar/ChineseCalendar;->DAY_OF_YEAR:Lnet/time4j/calendar/StdCalendarElement;
    ...
    const-class v11, Lnet/time4j/calendar/ChineseCalendar;

    invoke-direct {v8, v11, v10}, Lnet/time4j/calendar/service/StdWeekdayElement;-><init>(Ljava/lang/Class;Lnet/time4j/Weekmodel;)V

    sput-object v8, Lnet/time4j/calendar/ChineseCalendar;->DAY_OF_WEEK:Lnet/time4j/calendar/StdCalendarElement;

    .line 508
    new-instance v10, Lnet/time4j/calendar/WeekdayInMonthElement;

    invoke-direct {v10, v11, v6, v8}, Lnet/time4j/calendar/WeekdayInMonthElement;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;)V

    sput-object v10, Lnet/time4j/calendar/ChineseCalendar;->WIM_ELEMENT:Lnet/time4j/calendar/WeekdayInMonthElement;

    .line 518
    sput-object v10, Lnet/time4j/calendar/ChineseCalendar;->WEEKDAY_IN_MONTH:Lnet/time4j/calendar/OrdinalWeekdayElement;
    ...
    .line 535
    invoke-virtual {v0, v9, v14}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/TimeAxis$Builder;

    move-result-object v0

    new-instance v9, Lnet/time4j/calendar/ChineseCalendar$YearOfEraRule;

    invoke-direct {v9, v13}, Lnet/time4j/calendar/ChineseCalendar$YearOfEraRule;-><init>(Lnet/time4j/calendar/ChineseCalendar$1;)V

    .line 538
    invoke-virtual {v0, v1, v9}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/TimeAxis$Builder;

    move-result-object v0

    .line 543
    invoke-static {v4}, Lnet/time4j/calendar/EastAsianCalendar;->getYearOfCycleRule(Lnet/time4j/engine/ChronoElement;)Lnet/time4j/engine/ElementRule;

    move-result-object v1

    sget-object v9, Lnet/time4j/calendar/ChineseCalendar$Unit;->YEARS:Lnet/time4j/calendar/ChineseCalendar$Unit;

    .line 541
    invoke-virtual {v0, v2, v1, v9}, Lnet/time4j/engine/TimeAxis$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;Ljava/lang/Object;)Lnet/time4j/engine/TimeAxis$Builder;
    ...
    .line 550
    invoke-static {v6}, Lnet/time4j/calendar/EastAsianCalendar;->getMonthOfYearRule(Lnet/time4j/engine/ChronoElement;)Lnet/time4j/engine/ElementRule;

    move-result-object v1

    sget-object v2, Lnet/time4j/calendar/ChineseCalendar$Unit;->MONTHS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    .line 554
    invoke-static {v6}, Lnet/time4j/calendar/EastAsianCalendar;->getMonthAsOrdinalRule(Lnet/time4j/engine/ChronoElement;)Lnet/time4j/engine/ElementRule;
    ...
    sget-object v2, Lnet/time4j/calendar/ChineseCalendar$Unit;->DAYS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    new-instance v3, Lnet/time4j/calendar/ChineseCalendar$1;

    invoke-direct {v3}, Lnet/time4j/calendar/ChineseCalendar$1;-><init>()V
    ...
    invoke-direct {v2, v12, v7}, Lnet/time4j/calendar/RelatedGregorianYearRule;-><init>(Lnet/time4j/engine/CalendarSystem;Lnet/time4j/engine/ChronoElement;)V
    ...
    sget-object v0, Lnet/time4j/calendar/ChineseCalendar$Unit;->CYCLES:Lnet/time4j/calendar/ChineseCalendar$Unit;

    .line 585
    invoke-virtual {v0}, Lnet/time4j/calendar/ChineseCalendar$Unit;->getLength()D
    ...
    sget-object v3, Lnet/time4j/calendar/ChineseCalendar$Unit;->YEARS:Lnet/time4j/calendar/ChineseCalendar$Unit;

    .line 590
    invoke-virtual {v3}, Lnet/time4j/calendar/ChineseCalendar$Unit;->getLength()D

    move-result-wide v3

    sget-object v5, Lnet/time4j/calendar/ChineseCalendar$Unit;->CYCLES:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    sget-object v13, Lnet/time4j/calendar/ChineseCalendar$Unit;->MONTHS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    sget-object v0, Lnet/time4j/calendar/ChineseCalendar$Unit;->MONTHS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    sget-object v3, Lnet/time4j/calendar/ChineseCalendar$Unit;->WEEKS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    sget-object v5, Lnet/time4j/calendar/ChineseCalendar$Unit;->DAYS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    sget-object v13, Lnet/time4j/calendar/ChineseCalendar$Unit;->DAYS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    sget-object v0, Lnet/time4j/calendar/ChineseCalendar$Unit;->DAYS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    sget-object v0, Lnet/time4j/calendar/ChineseCalendar$Unit;->WEEKS:Lnet/time4j/calendar/ChineseCalendar$Unit;
    ...
    invoke-direct {v1, v11, v6, v7, v2}, Lnet/time4j/calendar/CommonElements$Weekengine;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;Lnet/time4j/Weekmodel;)V
