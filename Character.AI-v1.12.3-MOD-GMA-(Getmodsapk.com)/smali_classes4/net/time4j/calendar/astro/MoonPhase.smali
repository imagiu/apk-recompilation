...
.method public atLunation(I)Lnet/time4j/Moment;
    ...
    const-wide v12, 0x4075d6b851eb851fL    # 349.42

    add-double/2addr v6, v12

    const-wide v12, 0x403234cc144028e5L    # 18.206239

    mul-double/2addr v12, v10

    const-wide v16, 0x40552a3d70a3d70aL    # 84.66

    add-double v12, v12, v16

    const-wide v16, 0x404aa6e1f7d73c92L    # 53.303771

    mul-double v16, v16, v10

    const-wide v18, 0x4061b7ae147ae148L    # 141.74

    add-double v16, v16, v18

    const-wide v18, 0x4003a13e3e29307bL    # 2.453732

    mul-double v18, v18, v10

    const-wide v20, 0x4069e47ae147ae14L    # 207.14

    add-double v18, v18, v20

    const-wide v20, 0x401d3a398201cd60L    # 7.30686

    mul-double v20, v20, v10

    const-wide v22, 0x40635ae147ae147bL    # 154.84

    add-double v20, v20, v22

    const-wide v22, 0x403b42e08f217093L    # 27.261239

    mul-double v22, v22, v10

    const-wide v24, 0x4041428f5c28f5c3L    # 34.52

    add-double v22, v22, v24

    const-wide v24, 0x3fbf2fdb8fde2ef5L    # 0.121824

    mul-double v24, v24, v10

    const-wide v26, 0x4069e6147ae147aeL    # 207.19

    add-double v24, v24, v26

    const-wide v26, 0x3ffd82938de6ddf0L    # 1.844379

    mul-double v26, v26, v10

    const-wide v28, 0x40723570a3d70a3dL    # 291.34

    add-double v26, v26, v28

    const-wide v28, 0x403832ba38759253L    # 24.198154

    mul-double v28, v28, v10

    const-wide v30, 0x4064370a3d70a3d7L    # 161.72

    add-double v28, v28, v30

    const-wide v30, 0x4039835a74c09c3dL    # 25.513099

    mul-double v30, v30, v10

    const-wide v32, 0x406df1eb851eb852L    # 239.56

    add-double v30, v30, v32

    const-wide v32, 0x400cbd7a13c254a4L    # 3.592518

    mul-double v10, v10, v32

    const-wide v32, 0x4074b8cccccccccdL    # 331.55
