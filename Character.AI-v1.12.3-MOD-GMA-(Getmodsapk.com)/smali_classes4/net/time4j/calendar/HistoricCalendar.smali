...
.method static constructor <clinit>()V
    ...
    .line 290
    new-instance v3, Lnet/time4j/calendar/HistoricCalendar$1;
    ...
    invoke-direct {v11, v4}, Lnet/time4j/calendar/HistoricCalendar$MonthOperator;-><init>(Z)V

    new-instance v12, Lnet/time4j/calendar/HistoricCalendar$MonthOperator;

    const/4 v13, 0x0

    invoke-direct {v12, v13}, Lnet/time4j/calendar/HistoricCalendar$MonthOperator;-><init>(Z)V
    ...
    sput-object v3, Lnet/time4j/calendar/HistoricCalendar;->MONTH_OF_YEAR:Lnet/time4j/calendar/StdCalendarElement;
    ...
    sput-object v6, Lnet/time4j/calendar/HistoricCalendar;->DAY_OF_MONTH:Lnet/time4j/calendar/StdCalendarElement;
    ...
    sput-object v14, Lnet/time4j/calendar/HistoricCalendar;->DAY_OF_YEAR:Lnet/time4j/calendar/StdCalendarElement;
    ...
    sput-object v7, Lnet/time4j/calendar/HistoricCalendar;->DAY_OF_WEEK:Lnet/time4j/calendar/StdCalendarElement;

    .line 347
    new-instance v8, Lnet/time4j/calendar/HistoricCalendar$SimpleElement;

    const-string v10, "HC_CONTINUOUS_DOM"

    const/16 v11, 0x1f

    invoke-direct {v8, v10, v4, v11, v5}, Lnet/time4j/calendar/HistoricCalendar$SimpleElement;-><init>(Ljava/lang/String;IILnet/time4j/calendar/HistoricCalendar$1;)V

    sput-object v8, Lnet/time4j/calendar/HistoricCalendar;->CONTINUOUS_DOM:Lnet/time4j/engine/ChronoElement;

    .line 349
    new-instance v4, Lnet/time4j/calendar/WeekdayInMonthElement;

    invoke-direct {v4, v9, v8, v7}, Lnet/time4j/calendar/WeekdayInMonthElement;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;)V

    sput-object v4, Lnet/time4j/calendar/HistoricCalendar;->WIM_ELEMENT:Lnet/time4j/calendar/WeekdayInMonthElement;

    .line 359
    sput-object v4, Lnet/time4j/calendar/HistoricCalendar;->WEEKDAY_IN_MONTH:Lnet/time4j/calendar/OrdinalWeekdayElement;

    .line 365
    new-instance v10, Lnet/time4j/calendar/HistoricCalendar$VariantMap;

    invoke-direct {v10, v5}, Lnet/time4j/calendar/HistoricCalendar$VariantMap;-><init>(Lnet/time4j/calendar/HistoricCalendar$1;)V
    ...
    invoke-direct {v15, v11}, Lnet/time4j/calendar/HistoricCalendar$Transformer;-><init>(Lnet/time4j/history/ChronoHistory;)V
    ...
    invoke-direct {v11, v5}, Lnet/time4j/calendar/HistoricCalendar$Merger;-><init>(Lnet/time4j/calendar/HistoricCalendar$1;)V

    .line 371
    invoke-static {v9, v11, v10}, Lnet/time4j/engine/CalendarFamily$Builder;->setUp(Ljava/lang/Class;Lnet/time4j/engine/ChronoMerger;Ljava/util/Map;)Lnet/time4j/engine/CalendarFamily$Builder;
    ...
    .line 375
    invoke-virtual {v11, v12, v15}, Lnet/time4j/engine/CalendarFamily$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/CalendarFamily$Builder;

    move-result-object v11

    new-instance v12, Lnet/time4j/calendar/HistoricCalendar$EraRule;

    invoke-direct {v12, v5}, Lnet/time4j/calendar/HistoricCalendar$EraRule;-><init>(Lnet/time4j/calendar/HistoricCalendar$1;)V

    .line 378
    invoke-virtual {v11, v0, v12}, Lnet/time4j/engine/CalendarFamily$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/CalendarFamily$Builder;
    ...
    .line 381
    invoke-virtual {v0, v1, v11}, Lnet/time4j/engine/CalendarFamily$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/CalendarFamily$Builder;

    move-result-object v0

    new-instance v1, Lnet/time4j/calendar/HistoricCalendar$IntegerRule;

    invoke-direct {v1, v13}, Lnet/time4j/calendar/HistoricCalendar$IntegerRule;-><init>(I)V
    ...
    invoke-direct {v2, v10, v14}, Lnet/time4j/calendar/RelatedGregorianYearRule;-><init>(Ljava/util/Map;Lnet/time4j/engine/ChronoElement;)V
    ...
    .line 399
    invoke-virtual {v0, v14, v1}, Lnet/time4j/engine/CalendarFamily$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/CalendarFamily$Builder;
    ...
    new-instance v3, Lnet/time4j/calendar/HistoricCalendar$2;

    invoke-direct {v3}, Lnet/time4j/calendar/HistoricCalendar$2;-><init>()V
    ...
    .line 415
    invoke-static {v4}, Lnet/time4j/calendar/WeekdayInMonthElement;->getRule(Lnet/time4j/calendar/WeekdayInMonthElement;)Lnet/time4j/engine/ElementRule;

    move-result-object v1

    .line 413
    invoke-virtual {v0, v4, v1}, Lnet/time4j/engine/CalendarFamily$Builder;->appendElement(Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ElementRule;)Lnet/time4j/engine/CalendarFamily$Builder;
    ...
    invoke-direct {v1, v9, v6, v14, v2}, Lnet/time4j/calendar/CommonElements$Weekengine;-><init>(Ljava/lang/Class;Lnet/time4j/engine/ChronoElement;Lnet/time4j/engine/ChronoElement;Lnet/time4j/Weekmodel;)V
