...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/ChangeBounds;->Z:Lv0/m;
...
.method public G()[Ljava/lang/String;
    ...
    sget-object p0, Landroidx/transition/ChangeBounds;->S:[Ljava/lang/String;
...
.method public i(Lv0/r;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/transition/ChangeBounds;->i0(Lv0/r;)V
...
.method public final i0(Lv0/r;)V
    ...
    iget-object v2, p1, Lv0/r;->b:Landroid/view/View;
    ...
    iget-object v2, p0, Landroidx/transition/ChangeBounds;->P:[I
    ...
    .line 11
    :cond_1
    iget-boolean p0, p0, Landroidx/transition/ChangeBounds;->Q:Z
    ...
    invoke-static {v0}, Lf0/x;->s(Landroid/view/View;)Landroid/graphics/Rect;
...
.method public final j0(Landroid/view/View;Landroid/view/View;)Z
    .locals 2

    .line 1
    iget-boolean v0, p0, Landroidx/transition/ChangeBounds;->R:Z
...
.method public k0(Z)V
    ...
    iput-boolean p1, p0, Landroidx/transition/ChangeBounds;->Q:Z
...
.method public p(Landroid/view/ViewGroup;Lv0/r;Lv0/r;)Landroid/animation/Animator;
    ...
    .line 1
    :cond_0
    iget-object v3, v0, Lv0/r;->a:Ljava/util/Map;

    .line 2
    iget-object v4, v1, Lv0/r;->a:Ljava/util/Map;
    ...
    .line 5
    :cond_1
    iget-object v9, v1, Lv0/r;->b:Landroid/view/View;

    .line 6
    invoke-virtual {v8, v3, v4}, Landroidx/transition/ChangeBounds;->j0(Landroid/view/View;Landroid/view/View;)Z
    ...
    .line 8
    iget-object v6, v1, Lv0/r;->a:Ljava/util/Map;
    ...
    .line 17
    iget-object v0, v0, Lv0/r;->a:Ljava/util/Map;
    ...
    .line 18
    iget-object v1, v1, Lv0/r;->a:Ljava/util/Map;
    ...
    .line 21
    invoke-static {v9, v6, v11, v13, v3}, Lv0/y;->g(Landroid/view/View;IIII)V
    ...
    invoke-static {v9, v1, v0}, Lv0/k;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 27
    invoke-static {v1, v4, v2}, Lv0/k;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    invoke-static {v1, v4, v3}, Lv0/k;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 39
    invoke-static {v9, v6, v11, v1, v3}, Lv0/y;->g(Landroid/view/View;IIII)V
    ...
    invoke-static {v9, v3, v1}, Lv0/k;->a(Ljava/lang/Object;Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/ObjectAnimator;
    ...
    .line 45
    invoke-static {v9, v1}, Lf0/x;->w0(Landroid/view/View;Landroid/graphics/Rect;)V

    .line 46
    sget-object v4, Landroidx/transition/ChangeBounds;->Z:Lv0/m;
    ...
    .line 48
    :goto_8
    invoke-static {v11, v2}, Landroidx/transition/d;->c(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    ...
    .line 51
    invoke-static {v1, v2}, Lv0/v;->c(Landroid/view/ViewGroup;Z)V
    ...
    .line 54
    :cond_17
    iget-object v2, v0, Lv0/r;->a:Ljava/util/Map;
    ...
    .line 56
    iget-object v5, v1, Lv0/r;->a:Ljava/util/Map;
    ...
    .line 63
    invoke-static {v9}, Lv0/y;->c(Landroid/view/View;)F
    ...
    .line 64
    invoke-static {v9, v4}, Lv0/y;->h(Landroid/view/View;F)V

    .line 65
    invoke-static/range {p1 .. p1}, Lv0/y;->b(Landroid/view/View;)Lv0/x;

    move-result-object v4

    invoke-interface {v4, v6}, Lv0/x;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v1, v0}, Lv0/l;->a(Landroid/util/Property;Landroid/graphics/Path;)Landroid/animation/PropertyValuesHolder;
