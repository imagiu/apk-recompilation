...
.field public static i:Landroidx/appcompat/widget/z;

.field public static final j:Landroidx/appcompat/widget/z$a;
...
.field public g:Landroidx/appcompat/widget/z$c;
...
.method public static declared-synchronized k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/appcompat/widget/z$a;->k(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    .line 3
    invoke-virtual {v1, p0, p1, v2}, Landroidx/appcompat/widget/z$a;->l(ILandroid/graphics/PorterDuff$Mode;Landroid/graphics/PorterDuffColorFilter;)Landroid/graphics/PorterDuffColorFilter;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public static o(Landroidx/appcompat/widget/z;)V
    .locals 0
...
.method public static v(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/h0;[I)V
    .locals 3
    ...
    .line 2
    invoke-static {p0}, Landroidx/appcompat/widget/t;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 8
    :cond_2
    iget-boolean v0, p1, Landroidx/appcompat/widget/h0;->d:Z

    if-nez v0, :cond_4

    iget-boolean v1, p1, Landroidx/appcompat/widget/h0;->c:Z
    ...
    .line 10
    iget-object v0, p1, Landroidx/appcompat/widget/h0;->a:Landroid/content/res/ColorStateList;
    ...
    iget-object p1, p1, Landroidx/appcompat/widget/h0;->b:Landroid/graphics/PorterDuff$Mode;
...
.method public final declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Ll/d;->j(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    .line 6
    :cond_1
    invoke-virtual {v0, p2, p3}, Ll/h;->a(ILjava/lang/Object;)V
...
.method public final e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    invoke-virtual {p0, p1, v1, v2}, Landroidx/appcompat/widget/z;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    .line 8
    :cond_2
    invoke-interface {v3, p0, p1, p2}, Landroidx/appcompat/widget/z$c;->a(Landroidx/appcompat/widget/z;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 10
    invoke-virtual {p0, p1, v1, v2, p2}, Landroidx/appcompat/widget/z;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method public final declared-synchronized h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3}, Ll/d;->f(J)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Ll/d;->k(J)V
    :try_end_2
...
.method public declared-synchronized j(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/z;->c(Landroid/content/Context;)V

    .line 2
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/z;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/z;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/z;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized l(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/z;->m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    invoke-interface {v0, p1, p2}, Landroidx/appcompat/widget/z$c;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/z;->b(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final m(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    invoke-virtual {p0, p2}, Ll/h;->f(I)Ljava/lang/Object;
...
.method public n(I)Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_0
    invoke-interface {p0, p1}, Landroidx/appcompat/widget/z$c;->e(I)Landroid/graphics/PorterDuff$Mode;
...
.method public final q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/z;->b:Ll/g;
    ...
    .line 2
    iget-object v0, p0, Landroidx/appcompat/widget/z;->c:Ll/h;
    ...
    .line 3
    invoke-virtual {v0, p2}, Ll/h;->f(I)Ljava/lang/Object;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/z;->b:Ll/g;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/z;->c:Ll/h;
    ...
    .line 13
    invoke-virtual {p0, p1, v4, v5}, Landroidx/appcompat/widget/z;->h(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    .line 19
    iget-object v8, p0, Landroidx/appcompat/widget/z;->c:Ll/h;

    invoke-virtual {v8, p2, v3}, Ll/h;->a(ILjava/lang/Object;)V

    .line 20
    iget-object v8, p0, Landroidx/appcompat/widget/z;->b:Ll/g;
    ...
    .line 24
    invoke-virtual {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/z;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    .line 27
    iget-object p0, p0, Landroidx/appcompat/widget/z;->c:Ll/h;

    invoke-virtual {p0, p2, v2}, Ll/h;->a(ILjava/lang/Object;)V
...
.method public declared-synchronized s(Landroid/content/Context;Landroidx/appcompat/widget/n0;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p1, p3}, Landroidx/appcompat/widget/z;->q(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p0, p1, p3, p2, v0}, Landroidx/appcompat/widget/z;->u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method public final u(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 4
    :cond_0
    invoke-static {p4}, Ly/a;->r(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;

    move-result-object p4

    .line 5
    invoke-static {p4, v0}, Ly/a;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    .line 7
    invoke-static {p4, p0}, Ly/a;->p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-interface {v0, p1, p2, p4}, Landroidx/appcompat/widget/z$c;->d(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method public w(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-interface {p0, p1, p2, p3}, Landroidx/appcompat/widget/z$c;->b(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
