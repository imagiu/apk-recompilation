...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/l;->c:[I
...
.method public constructor <init>(Landroid/widget/ProgressBar;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/appcompat/widget/l;->a:Landroid/widget/ProgressBar;
...
.method public b()Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/l;->b:Landroid/graphics/Bitmap;
...
.method public c(Landroid/util/AttributeSet;I)V
    ...
    .line 1
    iget-object v0, p0, Landroidx/appcompat/widget/l;->a:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroidx/appcompat/widget/l;->c:[I
    ...
    .line 2
    invoke-virtual {p1, v2}, Landroidx/appcompat/widget/j0;->h(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/l;->e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p2, v2}, Landroidx/appcompat/widget/l;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0}, Ly/b;->a()Landroid/graphics/drawable/Drawable;
    ...
    .line 3
    invoke-virtual {p0, v1, p2}, Landroidx/appcompat/widget/l;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;

    move-result-object p0

    .line 4
    invoke-interface {v0, p0}, Ly/b;->b(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Landroidx/appcompat/widget/l;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 13
    invoke-static {p1, p0, v2}, Landroidx/appcompat/widget/l$a;->a(Landroid/graphics/drawable/LayerDrawable;Landroid/graphics/drawable/LayerDrawable;I)V
    ...
    .line 17
    iget-object v2, p0, Landroidx/appcompat/widget/l;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    .line 18
    iput-object v0, p0, Landroidx/appcompat/widget/l;->b:Landroid/graphics/Bitmap;

    .line 19
    :cond_6
    new-instance v2, Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {p0}, Landroidx/appcompat/widget/l;->a()Landroid/graphics/drawable/shapes/Shape;
...
.method public final e(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v4, v5}, Landroidx/appcompat/widget/l;->d(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
