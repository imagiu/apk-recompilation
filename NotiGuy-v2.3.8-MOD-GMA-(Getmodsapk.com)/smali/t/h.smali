...
# direct methods
.method public constructor <init>(Lt/g$d;)V
    .locals 11
    ...
    iput-object v0, p0, Lt/h;->f:Ljava/util/List;
    ...
    iput-object v0, p0, Lt/h;->g:Landroid/os/Bundle;

    .line 4
    iput-object p1, p0, Lt/h;->c:Lt/g$d;

    .line 5
    iget-object v0, p1, Lt/g$d;->a:Landroid/content/Context;

    iput-object v0, p0, Lt/h;->a:Landroid/content/Context;

    .line 6
    new-instance v0, Landroid/app/Notification$Builder;

    iget-object v1, p1, Lt/g$d;->a:Landroid/content/Context;

    iget-object v2, p1, Lt/g$d;->K:Ljava/lang/String;

    invoke-direct {v0, v1, v2}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    iput-object v0, p0, Lt/h;->b:Landroid/app/Notification$Builder;

    .line 7
    iget-object v1, p1, Lt/g$d;->R:Landroid/app/Notification;
    ...
    iget-object v4, p1, Lt/g$d;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v3, p1, Lt/g$d;->e:Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Lt/g$d;->f:Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Lt/g$d;->k:Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Lt/g$d;->g:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Lt/g$d;->h:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Lt/g$d;->j:Landroid/graphics/Bitmap;
    ...
    iget v3, p1, Lt/g$d;->t:I

    iget v7, p1, Lt/g$d;->u:I

    iget-boolean v8, p1, Lt/g$d;->v:Z

    .line 26
    invoke-virtual {v2, v3, v7, v8}, Landroid/app/Notification$Builder;->setProgress(IIZ)Landroid/app/Notification$Builder;

    .line 27
    iget-object v2, p1, Lt/g$d;->q:Ljava/lang/CharSequence;
    ...
    iget v2, p1, Lt/g$d;->m:I

    .line 29
    invoke-virtual {v0, v2}, Landroid/app/Notification$Builder;->setPriority(I)Landroid/app/Notification$Builder;

    .line 30
    iget-object v0, p1, Lt/g$d;->b:Ljava/util/ArrayList;
    ...
    .line 31
    invoke-virtual {p0, v2}, Lt/h;->b(Lt/g$a;)V

    goto :goto_4

    .line 32
    :cond_4
    iget-object v0, p1, Lt/g$d;->D:Landroid/os/Bundle;

    if-eqz v0, :cond_5

    .line 33
    iget-object v2, p0, Lt/h;->g:Landroid/os/Bundle;

    invoke-virtual {v2, v0}, Landroid/os/Bundle;->putAll(Landroid/os/Bundle;)V

    .line 34
    :cond_5
    iget-object v0, p1, Lt/g$d;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lt/h;->d:Landroid/widget/RemoteViews;

    .line 35
    iget-object v0, p1, Lt/g$d;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lt/h;->e:Landroid/widget/RemoteViews;

    .line 36
    iget-object v0, p0, Lt/h;->b:Landroid/app/Notification$Builder;

    iget-boolean v2, p1, Lt/g$d;->n:Z
    ...
    iget-object v2, p1, Lt/g$d;->C:Ljava/lang/String;

    invoke-virtual {v0, v2}, Landroid/app/Notification$Builder;->setCategory(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v0

    iget v2, p1, Lt/g$d;->E:I
    ...
    iget-object v2, p1, Lt/g$d;->G:Landroid/app/Notification;
    ...
    .line 47
    iget-object v0, p1, Lt/g$d;->U:Ljava/util/ArrayList;
    ...
    .line 50
    iget-object v3, p0, Lt/h;->b:Landroid/app/Notification$Builder;
    ...
    .line 51
    :cond_6
    iget-object v0, p1, Lt/g$d;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, Lt/h;->i:Landroid/widget/RemoteViews;

    .line 52
    iget-object v0, p1, Lt/g$d;->d:Ljava/util/ArrayList;
    ...
    .line 53
    invoke-virtual {p1}, Lt/g$d;->c()Landroid/os/Bundle;
    ...
    .line 57
    :goto_6
    iget-object v9, p1, Lt/g$d;->d:Ljava/util/ArrayList;
    ...
    iget-object v10, p1, Lt/g$d;->d:Ljava/util/ArrayList;
    ...
    .line 60
    invoke-static {v10}, Lt/i;->a(Lt/g$a;)Landroid/os/Bundle;
    ...
    .line 65
    iget-object v0, p0, Lt/h;->g:Landroid/os/Bundle;

    invoke-virtual {v0, v2, v3}, Landroid/os/Bundle;->putBundle(Ljava/lang/String;Landroid/os/Bundle;)V

    .line 66
    :cond_9
    iget-object v0, p1, Lt/g$d;->T:Landroid/graphics/drawable/Icon;

    if-eqz v0, :cond_a

    .line 67
    iget-object v2, p0, Lt/h;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p1, Lt/g$d;->M:Ljava/lang/String;
    ...
    .line 88
    :cond_f
    iget-object v0, p1, Lt/g$d;->c:Ljava/util/ArrayList;
    ...
    .line 89
    iget-object v6, p0, Lt/h;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v3}, Lt/k;->g()Landroid/app/Person;
    ...
    .line 93
    invoke-static {v2}, Lt/g$c;->a(Lt/g$c;)Landroid/app/Notification$BubbleMetadata;
    ...
    .line 97
    :cond_11
    iget-boolean p1, p1, Lt/g$d;->S:Z

    if-eqz p1, :cond_14

    .line 98
    iget-object p1, p0, Lt/h;->c:Lt/g$d;

    iget-boolean p1, p1, Lt/g$d;->x:Z
    ...
    .line 101
    :goto_8
    iget-object p1, p0, Lt/h;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, Lt/g$d;->w:Ljava/lang/String;
...
.method public a()Landroid/app/Notification$Builder;
    ...
    iget-object p0, p0, Lt/h;->b:Landroid/app/Notification$Builder;

    return-object p0
.end method

.method public final b(Lt/g$a;)V
    .locals 5

    .line 1
    invoke-virtual {p1}, Lt/g$a;->d()Landroidx/core/graphics/drawable/IconCompat;
    ...
    .line 4
    :goto_0
    invoke-virtual {p1}, Lt/g$a;->h()Ljava/lang/CharSequence;

    move-result-object v2

    .line 5
    invoke-virtual {p1}, Lt/g$a;->a()Landroid/app/PendingIntent;
    ...
    .line 6
    invoke-virtual {p1}, Lt/g$a;->e()[Lt/m;
    ...
    .line 8
    invoke-static {v0}, Lt/m;->b([Lt/m;)[Landroid/app/RemoteInput;
    ...
    .line 10
    :cond_1
    invoke-virtual {p1}, Lt/g$a;->c()Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    .line 1
    iget-object v0, p0, Lt/h;->c:Lt/g$d;

    iget-object v0, v0, Lt/g$d;->p:Lt/g$e;

    if-eqz v0, :cond_0

    .line 2
    invoke-virtual {v0, p0}, Lt/g$e;->b(Lt/f;)V

    :cond_0
    if-eqz v0, :cond_1

    .line 3
    invoke-virtual {v0, p0}, Lt/g$e;->e(Lt/f;)Landroid/widget/RemoteViews;
    ...
    .line 4
    :goto_0
    invoke-virtual {p0}, Lt/h;->d()Landroid/app/Notification;
    ...
    .line 6
    :cond_2
    iget-object v1, p0, Lt/h;->c:Lt/g$d;

    iget-object v1, v1, Lt/g$d;->H:Landroid/widget/RemoteViews;
    ...
    .line 8
    invoke-virtual {v0, p0}, Lt/g$e;->d(Lt/f;)Landroid/widget/RemoteViews;
    ...
    iget-object v1, v1, Lt/g$d;->p:Lt/g$e;

    .line 11
    invoke-virtual {v1, p0}, Lt/g$e;->f(Lt/f;)Landroid/widget/RemoteViews;
    ...
    .line 13
    invoke-static {v2}, Lt/g;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    .line 14
    invoke-virtual {v0, p0}, Lt/g$e;->a(Landroid/os/Bundle;)V
